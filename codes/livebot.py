...
def calculate_position_size(
    ...
    try:
        ...
        if market_info.get("linear", True) or not is_contract:
            ...
            contract_value_quote = Decimal("1")  # Placeholder - **VERIFY FOR SPECIFIC INVERSE CONTRACT**
    ...
    try:
        ...
        if has_tsl:
            ...
            if tsl_activation_price == 0:
                formatted_activation_price = "0"  # Use string '0' if activation is immediate/zero
...
def set_trailing_stop_loss(
    ...
    try:
        ...
        base_price_for_distance = entry_price if activation_price == 0 else activation_price
...
def analyze_and_trade_symbol(
    ...
    lg.info(f"ATR: {f'{current_atr:.{price_precision + 1}f}' if current_atr and pd.notna(current_atr) else 'N/A'}")
