            ...
            with open(filepath, encoding="utf-8") as f:
                ...
                for symbol, symbol_data_raw in state_raw.items():
                    ...
                    if isinstance(symbol_data_raw, dict):
                        ...
                        state[symbol] = {
                            k: (False if k == "break_even_triggered" else None) for k in expected_symbol_keys
                        }
...
class TradingAnalyzer:
    ...
    def _check_momentum(self) -> Optional[float]:
        ...
        scaling_factor = (
            0.1  # Example: If MOM often +/- 10, this scales it to +/- 1. Consider making this configurable.
        )
        ...
        if result and isinstance(result, dict):
            ...
            if ret_code == 0:
                ...
                if ret_code == 110041 or ret_code == 170140:
                    lg.warning(f"Hint: Failed because no active position found (Code {ret_code}).")
                    ...
                    lg.warning(f"Hint: Failed because TP/SL would trigger immediate liquidation (Code {ret_code}).")
                elif ret_code == 110025:
                    lg.warning(
        ...
        while True:
            ...
            for symbol in config.get("symbols", []):
                ...
                if signal["action"] == "buy" and position["size"] == 0:
                    order = {"type": "market", "side": "buy", "amount": signal["amount"], "symbol": symbol}
                    ...
                    order = {"type": "market", "side": "sell", "amount": position["size"], "symbol": symbol}
                    if place_order(exchange, symbol, order, symbol_logger):
