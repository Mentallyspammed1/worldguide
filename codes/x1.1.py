...
2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - INFO     - [livebot_BCH_USDT-USDT] - Signal Calculation Summary (BCH/USDT:USDT @ 349.20000000):                                               Weight Set: default                                   Indicators Used: 13 (0 NaN)                           Total Weight Applied: 2.900                           Final Weighted Score: 0.0713                          Signal Threshold: +/- 1.500                           ==> Final Signal: HOLD                              2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Error determining tick size for BCH/USDT:USDT: 'decimal.Decimal' object has no attribute 'is_integer'. Using fallback.                                       2025-04-24 12:48:29 - WARNING  - [livebot_BCH_USDT-USDT] - Using fallback tick size 1E-8 for BCH/USDT:USDT. 2025-04-24 12:48:29 - INFO     - [livebot_BCH_USDT-USDT] - Current ATR: 1.130494596 | Potential Initial SL/TP: N/A / N/A                                          2025-04-24 12:48:29 - INFO     - [livebot_BCH_USDT-USDT] - Configured Protections: TSL=On | BE=On | MA Exit=On                                                    2025-04-24 12:48:30 - INFO     - [livebot_BCH_USDT-USDT] - No active open position found for BCH/USDT:USDT. 2025-04-24 12:48:30 - INFO     - [livebot_BCH_USDT-USDT] - Signal is HOLD and no open position. No action.  2025-04-24 12:48:30 - INFO     - [livebot_BCH_USDT-USDT] - ---== Analysis Cycle End (2.02s) ==---           2025-04-24 12:48:45 - INFO     - [livebot_BCH_USDT-USDT] - ---== Analyzing BCH/USDT:USDT (3) Cycle Start ==---
2025-04-24 12:48:46#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
if not API_KEY or not API_SECRET:
    ...
    print(f"{NEON_RED}BYBIT_API_KEY and BYBIT_API_SECRET must be set in .env file{RESET}")
...
def setup_logger(symbol: str, console_level: int = logging.INFO) -> logging.Logger:
    ...
    if logger.hasHandlers():
        ...
        logger.debug(f"Logger '{logger_name}' already configured. Console level set to {logging.getLevelName(console_level)}.")
        return logger
...
def _ensure_config_keys(config: Dict[str, Any], default_config: Dict[str, Any]) -> Tuple[Dict[str, Any], bool]:
    ...
    for key, default_value in default_config.items():
        ...
        # Optional: Type mismatch check
             ...
             if not (isinstance(default_value, float) and isinstance(updated_config.get(key), int)):
    ...
    try:
        exchange_options = {
            ...
            'options': {
                ...
                'accounts': {
                    'future': {'linear': 'CONTRACT', 'inverse': 'CONTRACT'}, # Futures use CONTRACT
                    'swap': {'linear': 'CONTRACT', 'inverse': 'CONTRACT'},   # Swaps use CONTRACT
                    'option': {'unified': 'OPTION'},                        # Options use OPTION
                    'spot': {'unified': 'UNIFIED', 'spot': 'SPOT'},         # Spot can use UNIFIED or SPOT
        ...
        try:
            balance_decimal = fetch_balance(exchange, quote_currency, lg) # Use the enhanced fetch_balance
    ...
    try:
        ...
        if match_ms:
            ...
            if match_num: # Assume seconds if unit missing
                 ...
                 logger.warning(f"Could not parse rate limit wait time from '{error}'. Using default {default_wait}s.")
                 wait_sec = default_wait
        return wait_sec
    except Exception as parse_err:
        logger.warning(f"Error parsing rate limit wait time from '{error}': {parse_err}. Using default {default_wait}s.")
    return default_wait
        ...
        try:
            ...
            if 'bybit' in exchange.id.lower():
                 try:
                     ...
                     market_type = market.get('type', 'linear') # Default to linear if type missing
                     category = 'spot' if market_type == 'spot' else ('linear' if market.get('linear', True) else 'inverse')
                 except Exception:
            ...
            lg.error(f"{NEON_RED}Failed to extract a valid positive price from ticker for {symbol}.{RESET}")
            return None # No valid price found

        except ccxt.RateLimitExceeded as e:
            last_exception = e; wait_time = _handle_rate_limit(e, lg)
        ...
        try:
            ...
            if ohlcv is not None and len(ohlcv) > 0:
                try:
                    ...
                    if df.empty: lg.warning(f"Kline DataFrame empty for {symbol} {timeframe}."); return pd.DataFrame()

                    df['timestamp'] = pd.to_datetime(df['timestamp'], unit='ms', errors='coerce')
                    df.dropna(subset=['timestamp'], inplace=True)
                    if df.empty: lg.warning(f"Kline DataFrame empty after timestamp conversion for {symbol}."); return pd.DataFrame()
                    ...
                    if rows_dropped > 0: lg.debug(f"Dropped {rows_dropped} rows with NaN/invalid data for {symbol}.")
                    if df.empty: lg.warning(f"Kline data empty after cleaning for {symbol}."); return pd.DataFrame()
...
def fetch_orderbook_ccxt(exchange: ccxt.Exchange, symbol: str, limit: int, logger: logging.Logger) -> Optional[Dict]:
    ...
    for attempt in range(MAX_API_RETRIES + 1):
        try:
            ...
            if not orderbook:
                lg.warning(f"fetch_order_book returned None/empty for {symbol} (Attempt {attempt + 1}). Retrying...")
                ...
                lg.warning(f"{NEON_YELLOW}Invalid orderbook structure for {symbol}. Attempt {attempt + 1}. Response: {orderbook}{RESET}")
...
class TradingAnalyzer:
    ...
    def __init__(
        ...
        self.ta_column_names: Dict[str, Optional[str]] = {} # Stores actual TA column names
    ...
    def _get_ta_col_name(self, base_name: str, result_df: pd.DataFrame) -> Optional[str]:
        ...
        except (ValueError, TypeError): bb_std_dev = DEFAULT_BOLLINGER_BANDS_STD_DEV
        ...
        for pattern in patterns_to_check: # Check exact patterns first
            if pattern in available_columns: return pattern

        # Fallback: Check base name prefix (case-insensitive)
        base_lower = base_name.lower()
        for col in available_columns:
            if col.lower().startswith(base_lower + "_"): return col
        # Fallback: Check if base name is present (less specific)
        for col in available_columns:
            if base_lower in col.lower(): return col

        self.logger.warning(f"{NEON_YELLOW}Could not find column for indicator '{base_name}' in DF columns: {available_columns}{RESET}")
        return None
    ...
    def _calculate_all_indicators(self):
        ...
        periods_needed = [cfg.get("atr_period", DEFAULT_ATR_PERIOD)] # ATR always needed
        if indi_cfg.get("ema_alignment", False) or cfg.get("enable_ma_cross_exit", False):
            periods_needed.extend([cfg.get("ema_short_period", DEFAULT_EMA_SHORT_PERIOD), cfg.get("ema_long_period", DEFAULT_EMA_LONG_PERIOD)])
        for key, default in [("momentum", DEFAULT_MOMENTUM_PERIOD), ("cci", DEFAULT_CCI_WINDOW), ("wr", DEFAULT_WILLIAMS_R_WINDOW),
                             ("mfi", DEFAULT_MFI_WINDOW), ("sma_10", DEFAULT_SMA_10_WINDOW), ("rsi", DEFAULT_RSI_WINDOW),
                             ("bollinger_bands", DEFAULT_BOLLINGER_BANDS_PERIOD), ("volume_confirmation", DEFAULT_VOLUME_MA_PERIOD)]:
            if indi_cfg.get(key): periods_needed.append(cfg.get(f"{key}_period", default) if "period" in key else cfg.get(f"{key}_window", default))
        ...
        try:
            ...
            df_calc.ta.atr(length=cfg.get("atr_period", DEFAULT_ATR_PERIOD), append=True)
            ...
            if indi_cfg.get("momentum", False):
                df_calc.ta.mom(length=cfg.get("momentum_period", DEFAULT_MOMENTUM_PERIOD), append=True)
                self.ta_column_names["Momentum"] = self._get_ta_col_name("Momentum", df_calc)
            if indi_cfg.get("cci", False):
                df_calc.ta.cci(length=cfg.get("cci_window", DEFAULT_CCI_WINDOW), append=True)
                self.ta_column_names["CCI"] = self._get_ta_col_name("CCI", df_calc)
            if indi_cfg.get("wr", False):
                df_calc.ta.willr(length=cfg.get("williams_r_window", DEFAULT_WILLIAMS_R_WINDOW), append=True)
                self.ta_column_names["Williams_R"] = self._get_ta_col_name("Williams_R", df_calc)
            if indi_cfg.get("mfi", False):
                df_calc.ta.mfi(length=cfg.get("mfi_window", DEFAULT_MFI_WINDOW), append=True)
                self.ta_column_names["MFI"] = self._get_ta_col_name("MFI", df_calc)
            if indi_cfg.get("vwap", False):
                df_calc.ta.vwap(append=True); self.ta_column_names["VWAP"] = self._get_ta_col_name("VWAP", df_calc)
            if indi_cfg.get("psar", False):
                try:
                    psar_result = df_calc.ta.psar(af=cfg.get("psar_af", DEFAULT_PSAR_AF), max_af=cfg.get("psar_max_af", DEFAULT_PSAR_MAX_AF))
                    if psar_result is not None and not psar_result.empty:
                        for col in psar_result.columns: df_calc[col] = psar_result[col] # Append/Overwrite safely
                ...
                except Exception as e: self.logger.error(f"Error calculating PSAR for {self.symbol}: {e}")
            if indi_cfg.get("sma_10", False):
                df_calc.ta.sma(length=cfg.get("sma_10_window", DEFAULT_SMA_10_WINDOW), append=True)
                self.ta_column_names["SMA10"] = self._get_ta_col_name("SMA10", df_calc)
            if indi_cfg.get("stoch_rsi", False):
                try:
                    stochrsi_result = df_calc.ta.stochrsi(length=cfg.get("stoch_rsi_window", DEFAULT_STOCH_RSI_WINDOW),
                                                       rsi_length=cfg.get("stoch_rsi_rsi_window", DEFAULT_STOCH_WINDOW),
                                                       k=cfg.get("stoch_rsi_k", DEFAULT_K_WINDOW), d=cfg.get("stoch_rsi_d", DEFAULT_D_WINDOW))
                    if stochrsi_result is not None and not stochrsi_result.empty:
                         for col in stochrsi_result.columns: df_calc[col] = stochrsi_result[col]
                ...
                except Exception as e: self.logger.error(f"Error calculating StochRSI for {self.symbol}: {e}")
            ...
            if indi_cfg.get("bollinger_bands", False):
                try:
                    bb_std_float = float(cfg.get("bollinger_bands_std_dev", DEFAULT_BOLLINGER_BANDS_STD_DEV))
                    bbands_result = df_calc.ta.bbands(length=cfg.get("bollinger_bands_period", DEFAULT_BOLLINGER_BANDS_PERIOD), std=bb_std_float)
                    if bbands_result is not None and not bbands_result.empty:
                        for col in bbands_result.columns: df_calc[col] = bbands_result[col]
                ...
                except Exception as e: self.logger.error(f"Error calculating Bollinger Bands for {self.symbol}: {e}")
            if indi_cfg.get("volume_confirmation", False):
                try:
                    vol_ma_period = cfg.get("volume_ma_period", DEFAULT_VOLUME_MA_PERIOD)
                ...
                except Exception as e: self.logger.error(f"Error calculating Volume MA for {self.symbol}: {e}")
        ...
        try:
            ...
            for key, col_name in self.ta_column_names.items():
                if col_name and col_name in latest.index:
                    ...
                    updated_values[key] = float(value) if pd.notna(value) else float('nan')
                else:
                    updated_values[key] = float('nan') # Store NaN if column missing/invalid

            # Add essential price/volume data
            for base_col in ['open', 'high', 'low', 'close', 'volume']:
                value = latest.get(base_col)
                updated_values[base_col.capitalize()] = float(value) if pd.notna(value) else float('nan')

            self.indicator_values = updated_values
            valid_values = {k: f"{v:.5f}" if isinstance(v, float) and pd.notna(v) else v for k, v in self.indicator_values.items()}
    ...
    def get_min_tick_size(self) -> Decimal:
        ...
        try:
            ...
            if tick_str: return Decimal(str(tick_str))
            ...
            if min_price:
                 ...
                 if 0 < min_tick < 100: return min_tick # Heuristic check

        except (InvalidOperation, ValueError, TypeError, KeyError, Exception) as e:
            self.logger.warning(f"Error determining tick size for {self.symbol}: {e}. Using fallback.")

        fallback_tick = Decimal('0.00000001')
        self.logger.warning(f"Using fallback tick size {fallback_tick} for {self.symbol}.")
        ...
        try:
            ...
            if diff > 0 and min_tick > 0:
                for level_pct in FIB_LEVELS:
                    ...
                    level_price = (level_price_raw / min_tick).quantize(Decimal('1'), rounding=rounding) * min_tick
                 ...
                 for level_pct in FIB_LEVELS: levels[f"Fib_{level_pct * 100:.1f}%"] = level_price
            else: # Invalid tick size
                 self.logger.warning(f"Invalid min_tick_size for Fib quantization on {self.symbol}.")
                 return {}
    ...
    def get_nearest_fibonacci_levels(self, current_price: Decimal, num_levels: int = 3) -> List[Tuple[str, Decimal]]:
        ...
        if not self.fib_levels_data or current_price is None or current_price <= 0: return []
        try:
            level_distances = [{'name': name, 'level': level, 'distance': abs(current_price - level)}
                               for name, level in self.fib_levels_data.items() if isinstance(level, Decimal)]
            level_distances.sort(key=lambda x: x['distance'])
            return [(item['name'], item['level']) for item in level_distances[:num_levels]]
        except Exception as e:
            self.logger.error(f"Error finding nearest Fib levels for {self.symbol}: {e}", exc_info=True); return []
    ...
    def calculate_ema_alignment_score(self) -> float:
        ...
        if math.isnan(ema_short) or math.isnan(ema_long) or math.isnan(current_price): return float('nan')

        if current_price > ema_short > ema_long: return 1.0  # Bullish
        elif current_price < ema_short < ema_long: return -1.0 # Bearish
        else: return 0.0 # Neutral/Mixed
    ...
    def generate_trading_signal(self, current_price: Decimal, orderbook_data: Optional[Dict]) -> str:
        ...
        for indicator_key, enabled in self.config.get("indicators", {}).items():
            ...
            try: weight = Decimal(str(weight_str)); assert weight != 0
            except (InvalidOperation, ValueError, TypeError, AssertionError): continue # Skip invalid/zero weights
            ...
            if hasattr(self, check_method_name) and callable(getattr(self, check_method_name)):
                ...
                try:
                    if indicator_key == "orderbook":
                        indicator_score_float = method(orderbook_data, current_price) if orderbook_data else float('nan')
                    else: indicator_score_float = method()
                except Exception as e: self.logger.error(f"Error in check method {check_method_name} for {self.symbol}: {e}", exc_info=True)
                ...
                if not math.isnan(indicator_score_float):
                    try:
                        ...
                        self.logger.error(f"Error processing score for {indicator_key}: {calc_err}"); nan_indicator_count += 1
                else: nan_indicator_count += 1
            else: self.logger.warning(f"Check method '{check_method_name}' not found for enabled indicator: {indicator_key}")

        if total_weight_applied == 0:
            self.logger.warning(f"No indicators contributed to signal score for {self.symbol}. HOLDING.")
            final_signal = "HOLD"
        else:
            try:
            ...
            except (InvalidOperation, ValueError, TypeError): threshold = Decimal(str(default_threshold))
        ...
        log_msg = ( f"Signal Calculation Summary ({self.symbol} @ {current_price:.{price_precision}f}):\n"
    ...
    def _check_momentum(self) -> float:
        ...
        if math.isnan(mom): return float('nan')
    ...
    def _check_volume_confirmation(self) -> float:
        ...
        if math.isnan(vol) or math.isnan(vol_ma) or vol_ma <= 0: return float('nan')
        try: mult = float(self.config.get("volume_confirmation_multiplier", 1.5))
        except: mult = 1.5
        if vol > vol_ma * mult: return 0.7 # High volume confirmation
        if vol < vol_ma / mult: return -0.4 # Low volume lack of confirmation
        return 0.0 # Neutral
    def _check_stoch_rsi(self) -> float:
        k = self.indicator_values.get("StochRSI_K", float('nan')); d = self.indicator_values.get("StochRSI_D", float('nan'))
        ...
        elif k > d: score = max(score, 0.5) # K over D bullish bias
        elif k < d: score = min(score, -0.5) # K under D bearish bias
    ...
    def _check_rsi(self) -> float:
        ...
        if 30 < rsi < 70: return 1.0 - (rsi - 30.0) * (2.0 / 40.0) # Linear scale between levels
        return 0.0
    def _check_cci(self) -> float:
        ...
        if cci >= 100: return -0.6
        if -100 < cci < 100: return - (cci / 100.0) * 0.6 # Linear scale between levels
        return 0.0
    def _check_wr(self) -> float: # Williams %R
        ...
        if wr <= -80: return 1.0
        if wr >= -20: return -1.0
        if -80 < wr < -20: return 1.0 - (wr - (-80.0)) * (2.0 / 60.0) # Linear scale
        return 0.0
    def _check_psar(self) -> float:
        psar_l = self.indicator_values.get("PSAR_long", float('nan')) # Below price if active
        psar_s = self.indicator_values.get("PSAR_short", float('nan')) # Above price if active
        if not math.isnan(psar_l) and math.isnan(psar_s): return 1.0 # Uptrend
        if math.isnan(psar_l) and not math.isnan(psar_s): return -1.0 # Downtrend
    ...
    def _check_sma_10(self) -> float:
        ...
        if math.isnan(sma) or math.isnan(close): return float('nan')
    ...
    def _check_vwap(self) -> float:
        ...
        close = self.indicator_values.get("Close", float('nan'))
        if math.isnan(vwap) or math.isnan(close): return float('nan')
        if close > vwap: return 0.7
        if close < vwap: return -0.7
        return 0.0
    def _check_mfi(self) -> float:
        ...
        if 20 < mfi < 80: return 1.0 - (mfi - 20.0) * (2.0 / 60.0) # Linear scale
        return 0.0
    def _check_bollinger_bands(self) -> float:
        ...
        close = self.indicator_values.get("Close", float('nan'))
        if math.isnan(bbl) or math.isnan(bbu) or math.isnan(close): return float('nan')
        if close <= bbl: return 1.0 # Touch/below lower -> Bullish mean revert
        if close >= bbu: return -1.0 # Touch/above upper -> Bearish mean revert
    ...
    def _check_orderbook(self, orderbook_data: Optional[Dict], current_price: Decimal) -> float:
        ...
        if not orderbook_data: return float('nan')
        try:
            ...
            if total_vol <= 0: return 0.0 # Neutral if no volume
            obi = (bid_vol - ask_vol) / total_vol # OBI range: -1 to +1
            self.logger.debug(f"OBI ({levels} levels): BidVol={bid_vol:.4f}, AskVol={ask_vol:.4f}, OBI={obi:.4f}")
            return float(obi) # Return OBI as score
        except (InvalidOperation, ValueError, TypeError, IndexError) as e:
            self.logger.warning(f"Error calculating OBI for {self.symbol}: {e}"); return float('nan')
        except Exception as e: self.logger.error(f"Unexpected OBI error: {e}"); return float('nan')
    ...
    def calculate_entry_tp_sl(
        ...
        try:
            ...
            min_tick = self.get_min_tick_size()
            if min_tick <= 0: raise ValueError("Invalid min tick size for quantization")

            tp_offset = atr * tp_mult; sl_offset = atr * sl_mult
            take_profit, stop_loss = None, None

            if signal == "BUY":
                tp_raw = entry_price + tp_offset; sl_raw = entry_price - sl_offset
            ...
            self.logger.debug(f"Calculated TP/SL for {self.symbol} {signal}: Entry={entry_price:.{prec}f}, TP={tp_log}, SL={sl_log} (ATR={atr:.{prec+1}f})")
        ...
        try:
            ...
            for acc_type in account_types_to_try:
                try:
                    ...
                    if balance_info and ('info' in balance_info or currency in balance_info):
                         lg.debug(f"Received balance structure using accountType '{acc_type}'.")
                         break # Proceed to parse this structure
                    else:
                         lg.debug(f"Balance structure for accountType '{acc_type}' seems empty. Trying next.")
                         balance_info = None # Reset to try next type
                except ccxt.ExchangeError as e:
                    # Ignore "account type not support" errors and try the next type
                    ignore_msgs = ["account type not support", "invalid account type", "accounttype invalid", "10001"] # Added 10001
                    if any(msg in str(e).lower() for msg in ignore_msgs) or getattr(e, 'code', None) == 10001:
                        lg.debug(f"Account type '{acc_type}' not supported or error fetching: {e}. Trying next.")
                        continue
                    else: raise e # Re-raise other exchange errors
            ...
            # 2. Bybit V5 Nested: info -> result -> list -> coin[] (check relevant account type)
                ...
                for account in balance_list:
                    ...
                    if successful_acc_type == "Default" or current_account_type == successful_acc_type:
                        ...
                        if isinstance(coin_list, list):
                            for coin_data in coin_list:
                                if coin_data.get('coin') == currency:
                                    ...
                                    if free is None: free = coin_data.get('walletBalance') # Fallback
                                    if free is not None:
                                        available_balance_str = str(free)
                                        lg.debug(f"Found balance via Bybit V5 nested structure: {available_balance_str} {currency} (Account: {current_account_type or 'Unknown'})")
                                        break
                            if available_balance_str is not None: break
                if available_balance_str is None:
                    lg.warning(f"{currency} not found within Bybit V5 'info.result.list[].coin[]' for account type '{successful_acc_type}'.")
            ...
            if available_balance_str is None:
                 # Try standard total
                 total_str = str(balance_info.get(currency, {}).get('total', '')) if currency in balance_info else ''
                 ...
                 if total_str:
                     lg.warning(f"{NEON_YELLOW}Using 'total' balance ({total_str}) as fallback for {currency}.{RESET}")
            ...
            lg.error(f"Authentication error fetching balance: {e}. Check API keys/perms. Not retrying."); raise e
        except ccxt.ExchangeError as e:
            lg.error(f"Exchange error fetching balance: {e}. Not retrying."); last_exception = e; return None
        except Exception as e:
            lg.error(f"Unexpected error fetching balance: {e}. Not retrying.", exc_info=True); last_exception = e; return None
...
def get_market_info(exchange: ccxt.Exchange, symbol: str, logger: logging.Logger) -> Optional[Dict]:
    ...
    try:
        ...
        if not exchange.markets or symbol not in exchange.markets:
            lg.error(f"{NEON_RED}Market {symbol} not found after reloading markets.{RESET}")
            return None
        ...
        if market:
            ...
            market['is_linear'] = market.get('linear', market_type == 'linear' or (market_type == 'swap' and market.get('quote', '').endswith('USDT'))) # Heuristic for linear swap
            market['is_inverse'] = market.get('inverse', market_type == 'inverse' or (market_type == 'swap' and not market['is_linear']))
            market['contract_type'] = "Linear" if market['is_linear'] else "Inverse" if market['is_inverse'] else "Spot/Other"
            # Ensure market ID is present
            if 'id' not in market or not market['id']:
                market['id'] = market.get('info', {}).get('symbol', symbol.replace('/', '').split(':')[0]) # Fallback ID

            precision = market.get('precision', {}); limits = market.get('limits', {})
            lg.debug(f"Market Info ({symbol}): ID={market.get('id')}, Type={market_type}, Contract={market['is_contract']} ({market['contract_type']}), "
            ...
            lg.error(f"Market dictionary not found for {symbol} even after check."); return None
    except (ccxt.BadSymbol, ccxt.NetworkError, ccxt.ExchangeError, Exception) as e:
        lg.error(f"{NEON_RED}Error getting market info for {symbol}: {e}{RESET}", exc_info=True)
    return None
...
def _manual_amount_rounding(size: Decimal, precision_val: Any, lg: logging.Logger, symbol: str) -> Decimal:
    ...
    final_size = size; step_size = None; num_decimals = None
    try:
        if isinstance(precision_val, int) and precision_val >= 0: num_decimals = precision_val
        elif precision_val is not None: step_size = Decimal(str(precision_val)); assert step_size > 0
    except: step_size = None; num_decimals = None # Invalidate on error

    if step_size is not None:
        final_size = (size // step_size) * step_size # Floor division
        lg.debug(f"Applied manual amount step ({step_size}), rounded down: {size:.8f} -> {final_size}")
        ...
        lg.debug(f"Applied manual amount precision ({num_decimals} decimals), rounded down: {size:.8f} -> {final_size}")
    else: lg.warning(f"Amount precision '{precision_val}' invalid for manual rounding ({symbol}). Using unrounded: {size:.8f}")
    return final_size
...
def calculate_position_size(
    ...
    lg = logger; symbol = market_info.get('symbol', '???')
    quote = market_info.get('quote', QUOTE_CURRENCY); base = market_info.get('base', 'BASE')
    is_contract = market_info.get('is_contract', False)
    is_linear = market_info.get('is_linear', True); is_inverse = market_info.get('is_inverse', False)
    size_unit = "Contracts" if is_contract else base

    # --- Input Validation ---
    if balance <= 0 or not (0 < risk_per_trade < 1) or initial_stop_loss_price is None or entry_price <= 0 or initial_stop_loss_price == entry_price:
        lg.error(f"Position sizing failed ({symbol}): Invalid inputs (Balance={balance}, Risk={risk_per_trade}, SL={initial_stop_loss_price}, Entry={entry_price}).")
        return None
    if initial_stop_loss_price <= 0: lg.warning(f"Position sizing ({symbol}): Initial SL price ({initial_stop_loss_price}) is zero/negative.")
    ...
    try:
        ...
        if sl_distance_per_unit <= 0:
            lg.error(f"Position sizing failed ({symbol}): SL distance zero/negative ({sl_distance_per_unit})."); return None
        ...
        except: lg.warning(f"Invalid contract size '{contract_size_str}' for {symbol}. Defaulting to 1."); contract_size = Decimal('1')
        ...
        if is_linear or not is_contract: # Spot or Linear Contract
            ...
            if risk_per_contract_quote <= 0: raise ValueError("Risk per contract is zero/negative")
            ...
            value_of_1_contract_base = contract_size / entry_price # Assuming contract_size is Quote value (e.g., 1 USD)
            risk_per_contract_quote = sl_distance_per_unit * value_of_1_contract_base
            if risk_per_contract_quote <= 0: raise ValueError("Inverse risk per contract is zero/negative")
            calculated_size = risk_amount_quote / risk_per_contract_quote
        else: raise ValueError("Unknown contract type for sizing")

        lg.info(f"Position Sizing ({symbol}): Balance={balance:.2f} {quote}, Risk={risk_per_trade:.2%}, RiskAmt={risk_amount_quote:.4f} {quote}")
        lg.info(f"  Entry={entry_price}, SL={initial_stop_loss_price}, SLDist={sl_distance_per_unit}")
        lg.info(f"  ContractSize={contract_size}, Initial Calc. Size = {calculated_size:.8f} {size_unit}")

        # --- Apply Market Limits and Precision ---
        limits = market_info.get('limits', {}); amount_limits = limits.get('amount', {}); cost_limits = limits.get('cost', {})
        precision = market_info.get('precision', {}); amount_precision_val = precision.get('amount')

        def get_limit(d: dict, k: str, default: Decimal) -> Decimal:
            v = d.get(k); return Decimal(str(v)) if v is not None else default
        ...
        if adjusted_size != calculated_size: lg.warning(f"Size adjusted due to amount limits: {calculated_size:.8f} -> {adjusted_size:.8f}")

        # 2. Check COST limits
        cost_adjusted_size = adjusted_size; cost_limit_adjusted = False
        current_cost = Decimal('0')
        if is_linear or not is_contract: current_cost = adjusted_size * entry_price * contract_size
        elif is_inverse: current_cost = adjusted_size * contract_size # Assumes contract_size is Quote value

        lg.debug(f"  Cost Check: Adj. Size={adjusted_size:.8f}, Est. Cost={current_cost:.4f} (Min={min_cost}, Max={max_cost})")
        if min_cost > 0 and current_cost < min_cost and not math.isclose(float(current_cost), float(min_cost), rel_tol=1e-6):
            lg.warning(f"Estimated cost {current_cost:.4f} < min cost {min_cost:.4f}. Attempting size increase.")
            required_size = Decimal('0')
            if is_linear or not is_contract: required_size = min_cost / (entry_price * contract_size)
            elif is_inverse: required_size = min_cost / contract_size
            if required_size > max_amount: lg.error(f"Cannot meet min cost ({min_cost}) without exceeding max amount ({max_amount}). ABORT."); return None
            cost_adjusted_size = max(required_size, min_amount) # Ensure still meets min amount
            ...
            lg.warning(f"Estimated cost {current_cost:.4f} > max cost {max_cost:.4f}. Reducing size.")
            allowed_size = Decimal('0')
            if is_linear or not is_contract: allowed_size = max_cost / (entry_price * contract_size)
            elif is_inverse: allowed_size = max_cost / contract_size
            if allowed_size < min_amount: lg.error(f"Cannot meet max cost ({max_cost}) without going below min amount ({min_amount}). ABORT."); return None
        ...
        try: # Use ccxt helper first
            formatted_size_str = exchange.amount_to_precision(symbol, float(cost_adjusted_size), padding_mode=exchange.TRUNCATE)
            final_size = Decimal(formatted_size_str)
            lg.info(f"Applied amount precision (Truncated): {cost_adjusted_size:.8f} -> {final_size} {size_unit}")
        except (ccxt.BaseError, ValueError, TypeError, Exception) as fmt_err:
             lg.warning(f"Using manual rounding due to amount_to_precision error: {fmt_err}")
             final_size = _manual_amount_rounding(cost_adjusted_size, amount_precision_val, lg, symbol)

        # --- Final Validation ---
        if final_size <= 0: lg.error(f"Final size is zero/negative ({final_size}). ABORT."); return None
        if final_size < min_amount and not math.isclose(float(final_size), float(min_amount), rel_tol=1e-9):
             lg.error(f"Final size {final_size} < min amount {min_amount}. ABORT."); return None
        ...
        if not cost_limit_adjusted and min_cost > 0:
            ...
            if final_cost < min_cost and not math.isclose(float(final_cost), float(min_cost), rel_tol=1e-6):
                 lg.error(f"Final size {final_size} causes cost {final_cost:.4f} < min cost {min_cost}. ABORT."); return None

        lg.info(f"{NEON_GREEN}Final calculated position size for {symbol}: {final_size} {size_unit}{RESET}")
        return final_size

    except (KeyError, InvalidOperation, ValueError, TypeError, ZeroDivisionError, Exception) as e:
        lg.error(f"{NEON_RED}Position sizing error ({symbol}): {e}{RESET}", exc_info=True)
    return None
...
def get_open_position(exchange: ccxt.Exchange, symbol: str, logger: logging.Logger) -> Optional[Dict]:
    ...
    try:
        ...
        if 'bybit' in exchange.id.lower():
            ...
            params = {'category': category, 'symbol': market_id} # V5 requires symbol for single fetch
        ...
        try: # Bybit V5: fetch_positions with symbol param fetches that specific symbol
            positions = exchange.fetch_positions(symbols=None, params=params)
             ...
             lg.warning("Fetching all positions (fallback)..."); all_pos = exchange.fetch_positions()
             positions = [p for p in all_pos if p.get('symbol') == symbol]
        except ccxt.ExchangeError as e:
             # Handle "no position" errors gracefully (e.g., Bybit 110021)
             no_pos_codes = [110021]; no_pos_msgs = ['position idx not exist', 'no position found']
             err_code = getattr(e, 'code', None)
             if err_code in no_pos_codes or any(msg in str(e).lower() for msg in no_pos_msgs):
                 lg.info(f"No position found for {symbol} (Exchange: {e})."); return None
             lg.error(f"Exchange error fetching position for {symbol}: {e}", exc_info=True); return None

        active_position = None
        if not positions: lg.info(f"No position entries returned for {symbol}."); return None
        ...
        try:
            ...
            if amount_prec_val: min_size_threshold = Decimal(str(amount_prec_val)) * Decimal('0.1') # 10% of step size
        except: pass
        ...
        for pos in positions:
            ...
            try:
                ...
                if abs(pos_size) > min_size_threshold: active_position = pos; break
            except (InvalidOperation, ValueError, TypeError): continue

        if not active_position: lg.info(f"No active open position found for {symbol}."); return None
        ...
        active_position['is_tsl_active'] = active_position['trailingStopLossDistanceDecimal'] > 0

        # Log Position Details
        prec = 4; amt_prec = 4 # Defaults
        try: # Use analyzer helpers for precision
            analyzer = TradingAnalyzer(pd.DataFrame({'close':[1]}), lg, {}, market) # Dummy analyzer
            prec = analyzer.get_price_precision()
            amt_prec_val = market.get('precision', {}).get('amount')
            if amt_prec_val: amt_prec = abs(Decimal(str(amt_prec_val)).normalize().as_tuple().exponent) if not isinstance(amt_prec_val, int) else amt_prec_val
        except: pass

        def fmt(v: Any, p: int, zero_ok: bool = False) -> str:
             if v is None: return 'N/A'
             try: d = Decimal(str(v)); return f"{d:.{p}f}" if d > 0 or (d == 0 and zero_ok) else 'N/A'
             except: return str(v)
        ...
        lev = fmt(active_position.get('leverage', info.get('leverage')), 1) + 'x' if active_position.get('leverage') else 'N/A'
        ...
        tsl_dist = fmt(active_position.get('trailingStopLossDistanceDecimal'), prec, True)
...
def set_leverage_ccxt(exchange: ccxt.Exchange, symbol: str, leverage: int, market_info: Dict, logger: logging.Logger) -> bool:
    ...
    if not market_info or not market_info.get('is_contract', False):
        lg.info(f"Leverage setting skipped ({symbol}): Not a contract market."); return True
    ...
    try:
        ...
        params = {}; market_id = market_info.get('id')
        if not market_id: lg.error(f"Leverage setting failed ({symbol}): Missing market ID."); return False
        ...
        verified = False
        if response is None: verified = True # Assume success if no error and None response
        elif isinstance(response, dict):
             ret_code = response.get('retCode', response.get('info', {}).get('retCode'))
             if ret_code == 0: verified = True
             elif ret_code == 110045: lg.info(f"Leverage already set to {leverage}x (Code {ret_code})."); verified = True
             else: lg.warning(f"Set leverage returned non-zero retCode {ret_code} ({response.get('retMsg', 'N/A')}). Failed.")
        else: verified = True # Assume success if non-dict/None and no error

        if verified: lg.info(f"{NEON_GREEN}Leverage for {symbol} successfully set/confirmed at {leverage}x.{RESET}"); return True
        else: lg.error(f"Leverage setting failed verification for {symbol}."); return False

    except ccxt.ExchangeError as e:
        bybit_code = getattr(e, 'code', None)
        lg.error(f"{NEON_RED}Exchange error setting leverage for {symbol}: {e} (Code: {bybit_code}){RESET}")
        if bybit_code == 110045: lg.info(f"Leverage already set to {leverage}x."); return True # Treat as success
        # Add hints for common errors
        if bybit_code in [110028, 110009]: lg.error(f" >> Hint: Check Margin Mode (Isolated/Cross) for {symbol}.")
        elif bybit_code == 110044: lg.error(f" >> Hint: Leverage {leverage}x may exceed risk limit tier.")
        elif bybit_code == 110013: lg.error(f" >> Hint: Leverage value {leverage}x might be invalid.")
    except (ccxt.NetworkError, Exception) as e:
        lg.error(f"{NEON_RED}Error setting leverage for {symbol}: {e}{RESET}", exc_info=True)
    return False

def place_trade(
    exchange: ccxt.Exchange, symbol: str, trade_signal: str, position_size: Decimal,
    market_info: Dict, logger: logging.Logger, reduce_only: bool = False
) -> Optional[Dict]:
    """Places a market order using CCXT, handling Bybit V5 specifics."""
    lg = logger
    if not market_info: lg.error(f"Trade aborted ({symbol}): Missing market_info."); return None
    ...
    try: amount_float = float(abs(position_size)); assert amount_float > 0
    except: lg.error(f"Trade aborted ({symbol}): Invalid size {position_size}."); return None

    params = {'positionIdx': 0, 'reduceOnly': reduce_only} # Default to One-Way mode
    market_id = market_info.get('id')
    if not market_id: lg.error(f"Trade aborted ({symbol}): Missing market ID."); return None
    if 'bybit' in exchange.id.lower():
        category = 'linear' if market_info.get('is_linear', True) else 'inverse'
        params['category'] = category
    ...
    try:
        order = exchange.create_order(symbol=symbol, type=order_type, side=side,
                                      amount=amount_float, price=None, params=params)
        order_id = order.get('id', 'N/A'); status = order.get('status', 'N/A')
        lg.info(f"{NEON_GREEN}Trade Order Placed ({action})! ID: {order_id}, Status: {status}{RESET}")
        lg.debug(f"Raw order response ({symbol} {side} reduce={reduce_only}): {order}")
        return order

    except ccxt.InsufficientFunds as e: lg.error(f"{NEON_RED}Insufficient funds ({action} {symbol}): {e}{RESET}"); # Log balance hint
    except ccxt.InvalidOrder as e: lg.error(f"{NEON_RED}Invalid order ({action} {symbol}): {e}{RESET}"); # Log hints
        ...
        if bybit_code == 110025 and reduce_only: # Position not found on close attempt
             lg.warning(f"{NEON_YELLOW} >> Hint (110025): Position not found for closing. Already closed?{RESET}")
             return {'id': 'N/A', 'status': 'closed', 'info': {'retMsg': 'Position not found on close attempt'}} # Simulate success
        # Add other hints
...
def _set_position_protection(
    ...
    lg = logger
    if not market_info or not position_info or not market_info.get('is_contract', False):
        lg.error(f"Cannot set protection ({symbol}): Invalid input (market/pos info or not contract)."); return False
    pos_side = position_info.get('side'); market_id = market_info.get('id')
    if pos_side not in ['long', 'short'] or not market_id:
        lg.error(f"Cannot set protection ({symbol}): Invalid pos side ('{pos_side}') or market ID."); return False

    position_idx = 0 # Default One-Way
    try: # Get positionIdx from Bybit V5 info
        idx_val = position_info.get('id', position_info.get('info', {}).get('positionIdx'))
        if idx_val is not None and int(str(idx_val)) in [0, 1, 2]: position_idx = int(str(idx_val))
    except: pass

    def is_valid(val: Optional[Union[Decimal, str]]) -> bool:
        return val is not None and ((isinstance(val, str) and val == '0') or (isinstance(val, Decimal) and val >= 0))

    has_sl = stop_loss_price is not None; has_tp = take_profit_price is not None
    ...
    valid_tsl = has_tsl and is_valid(trailing_stop_distance) and (tsl_activation_price is None or is_valid(tsl_activation_price))

    if not valid_sl and not valid_tp and not valid_tsl:
        lg.info(f"No valid protection parameters provided for {symbol}. No action."); return True
    ...
    try: # Format parameters using exchange helpers
        def fmt(val: Union[Decimal, str]) -> str:
            if isinstance(val, str) and val == '0': return '0'
            if isinstance(val, Decimal):
                if val < 0: raise ValueError(f"Negative value {val} invalid")
                if val == 0: return '0'
                try: return exchange.price_to_precision(symbol, float(val))
                except Exception as e: raise ValueError(f"Formatting failed for {val}: {e}")
        ...
        if valid_tsl:
            ...
            if tsl_distance_fmt != '0':
                ...
                act_price = tsl_activation_price if tsl_activation_price is not None else Decimal('0')
                params_to_send['activePrice'] = fmt(act_price)
                log_parts.append(f"  TSL: Dist={params_to_send['trailingStop']}, Act={params_to_send['activePrice']}")
            else: # Explicitly cancelling TSL
                params_to_send['trailingStop'] = '0'; params_to_send['activePrice'] = '0'
        ...
        elif has_sl and tsl_distance_fmt != '0': lg.warning(f"Ignoring Fixed SL for {symbol} as active TSL is being set.")
        ...
        lg.error(f"{NEON_RED}Error formatting protection params for {symbol}: {fmt_err}. ABORTED.{RESET}"); return False
    except Exception as e: lg.error(f"Unexpected error preparing protection params: {e}", exc_info=True); return False

    if not params_to_send: lg.info(f"No protection parameters to set/modify for {symbol}. No API call."); return True

    params.update(params_to_send)
    lg.info("\n".join(log_parts)); lg.debug(f"  API Call Params: {params}")

    try: # Make the API Call
        method_name = 'private_post_v5_position_trading_stop'
        if not hasattr(exchange, method_name): raise NotImplementedError(f"Exchange missing '{method_name}'. Update CCXT?")
        response = getattr(exchange, method_name)(params)
        lg.debug(f"Set protection raw response for {symbol}: {response}")

        ret_code = response.get('retCode'); ret_msg = response.get('retMsg', 'N/A'); ret_ext = response.get('retExtInfo', {})
        if ret_code == 0:
            no_change = any(msg in ret_msg.lower() for msg in ["not modified", "same tpsl"])
            if no_change: lg.info(f"{NEON_YELLOW}Protection already set for {symbol} (Exchange: {ret_msg}).{RESET}")
            else: lg.info(f"{NEON_GREEN}Position protection set/updated successfully for {symbol}.{RESET}")
            return True
        else:
            lg.error(f"{NEON_RED}Failed to set protection for {symbol}: {ret_msg} (Code: {ret_code}) Ext: {ret_ext}{RESET}")
            # Add hints based on codes
            if ret_code == 110043: lg.error(" >> Hint: Check trigger prices, tpslMode.");
            elif ret_code == 110025: lg.error(" >> Hint: Position not found/zero size?");
            elif ret_code == 110013: lg.error(" >> Hint: Parameter error (invalid SL/TP/TSL value? tick size? wrong side?).");
            elif ret_code == 110036: lg.error(f" >> Hint: TSL Activation price ({params.get('activePrice')}) invalid?");
            return False
    except (NotImplementedError, ccxt.NetworkError, ccxt.ExchangeError, ccxt.BaseError, KeyError, Exception) as e:
        lg.error(f"{NEON_RED}Error during protection API call for {symbol}: {e}{RESET}", exc_info=True)
    return False
...
def set_trailing_stop_loss(
    ...
    if not config.get("enable_trailing_stop", False):
        lg.info(f"TSL disabled in config for {symbol}. Skipping."); return False # Not set, but not an error
    if not market_info or not position_info:
        lg.error(f"Cannot set TSL ({symbol}): Missing market/position info."); return False

    try: # Get config params
        callback_rate = Decimal(str(config["trailing_stop_callback_rate"])); assert callback_rate > 0
        activation_perc = Decimal(str(config["trailing_stop_activation_percentage"])); assert activation_perc >= 0
    except (KeyError, InvalidOperation, ValueError, TypeError, AssertionError) as e:
        lg.error(f"Invalid TSL config for {symbol}: {e}. Cannot set TSL."); return False

    try: # Get position details
        entry_str = position_info.get('entryPrice', position_info.get('info', {}).get('avgPrice'))
        pos_side = position_info.get('side')
        if entry_str is None or pos_side not in ['long', 'short']: raise ValueError("Missing entryPrice/side")
        entry_price = Decimal(str(entry_str)); assert entry_price > 0
    except (TypeError, ValueError, KeyError, InvalidOperation, AssertionError) as e:
        lg.error(f"Error parsing position info for TSL ({symbol}): {e}. Pos: {position_info}"); return False

    try: # Calculate TSL params for Bybit API
        analyzer = TradingAnalyzer(pd.DataFrame({'close':[1]}), lg, {}, market_info) # Dummy analyzer for helpers
        prec = analyzer.get_price_precision(); min_tick = analyzer.get_min_tick_size()
        if min_tick <= 0: raise ValueError(f"Invalid min tick size ({min_tick})")
        ...
        if activation_perc > 0:
            ...
            raw_act = entry_price + offset if pos_side == 'long' else entry_price - offset
            ...
            if (pos_side == 'long' and activation_price <= entry_price) or \
               (pos_side == 'short' and activation_price >= entry_price):
                 activation_price = (entry_price + (min_tick if pos_side == 'long' else -min_tick)).quantize(min_tick, rounding=rounding)
            if activation_price <= 0: lg.warning(f"TSL activation price invalid ({activation_price}). Defaulting to immediate."); activation_price = Decimal('0')
        else: lg.info(f"TSL immediate activation for {symbol}.")

        # 2. Trailing Distance (price points)
        dist_raw = entry_price * callback_rate
        # Round distance UP to nearest tick, min 1 tick
        trail_dist = max(min_tick, (dist_raw / min_tick).quantize(Decimal('1'), rounding=ROUND_UP) * min_tick)
        if trail_dist <= 0: raise ValueError(f"TSL distance invalid ({trail_dist})")

        act_log = f"{activation_price:.{prec}f}" if activation_price > 0 else '0 (Immediate)'
        tp_log = f"{take_profit_price:.{prec}f}" if take_profit_price else "None"
        lg.info(f"Calculated TSL Params ({symbol} {pos_side.upper()}): Activation={act_log}, Distance={trail_dist:.{prec}f}, TP={tp_log}")
        ...
        lg.error(f"{NEON_RED}Error calculating/setting TSL for {symbol}: {e}{RESET}", exc_info=True)
        return False
...
def analyze_and_trade_symbol(exchange: ccxt.Exchange, symbol: str, config: Dict[str, Any], logger: logging.Logger) -> None:
    ...
    if not ccxt_interval: lg.error(f"Invalid interval '{config['interval']}'. Skipping cycle."); return
    ...
    if klines_df.empty or len(klines_df) < 50:
        lg.error(f"Failed to fetch sufficient kline data for {symbol}. Skipping cycle."); return
    ...
    if current_price is None:
        ...
        try: last_close = Decimal(str(klines_df['close'].iloc[-1])); assert last_close > 0; current_price = last_close
        except: lg.error(f"Failed to get valid last close price for {symbol}. Cannot proceed."); return
    ...
    try: analyzer = TradingAnalyzer(klines_df.copy(), lg, config, market_info)
    except (ValueError, Exception) as e: lg.error(f"Failed to init TradingAnalyzer for {symbol}: {e}. Skipping cycle."); return
    if not analyzer.indicator_values: lg.error(f"Indicator calculation failed for {symbol}. Skipping cycle."); return
    ...
    lg.info(f"Current ATR: {atr_log} | Potential Initial SL/TP: {sl_pot_log} / {tp_pot_log}")
    tsl_on = config.get('enable_trailing_stop'); be_on = config.get('enable_break_even'); ma_exit_on = config.get('enable_ma_cross_exit')
    lg.info(f"Configured Protections: TSL={'On' if tsl_on else 'Off'} | BE={'On' if be_on else 'Off'} | MA Exit={'On' if ma_exit_on else 'Off'}")

    # --- 4. Check Position & Execute/Manage ---
    if not config.get("enable_trading", False):
        lg.info(f"{NEON_YELLOW}Trading disabled. Analysis complete, no actions taken.{RESET}")
    else:
        ...
        if open_position is None:
            if signal in ["BUY", "SELL"]:
                ...
                if balance is None or balance <= 0: lg.error(f"Trade Aborted ({signal}): Invalid balance."); return
                if sl_potential is None: lg.error(f"Trade Aborted ({signal}): Cannot size trade, SL calculation failed."); return
                ...
                if market_info.get('is_contract', False):
                    ...
                    if leverage > 0 and not set_leverage_ccxt(exchange, symbol, leverage, market_info, lg):
                        lg.error(f"Trade Aborted ({signal}): Failed to set/confirm leverage."); return
                position_size = calculate_position_size(balance, config["risk_per_trade"], sl_potential, current_price, market_info, exchange, lg)
                if position_size is None or position_size <= 0: lg.error(f"Trade Aborted ({signal}): Invalid position size calculated."); return
                ...
                if trade_order and trade_order.get('id'):
                    ...
                    if confirmed_position:
                        try:
                            entry_actual_str = confirmed_position.get('entryPrice', confirmed_position.get('info', {}).get('avgPrice'))
                            entry_actual = Decimal(str(entry_actual_str)) if entry_actual_str else None
                            if not entry_actual or entry_actual <= 0: raise ValueError("Invalid confirmed entry price")
                            lg.info(f"{NEON_GREEN}Position Confirmed! Actual Entry: ~{entry_actual:.{prec}f}{RESET}")

                            _, tp_actual, sl_actual = analyzer.calculate_entry_tp_sl(entry_actual, signal)
                            protection_set = False
                            if config.get("enable_trailing_stop", False):
                                lg.info(f"Setting Trailing Stop Loss (TP target: {tp_actual})...")
                                protection_set = set_trailing_stop_loss(exchange, symbol, market_info, confirmed_position, config, lg, tp_actual)
                            else: # Fixed SL/TP
                                lg.info(f"Setting Fixed SL ({sl_actual}) and TP ({tp_actual})...")
                                if sl_actual or tp_actual:
                                    protection_set = _set_position_protection(exchange, symbol, market_info, confirmed_position, lg, sl_actual, tp_actual, '0', '0')
                                else: lg.warning("Fixed SL/TP calculation failed. No fixed protection set."); protection_set = True

                            if protection_set: lg.info(f"{NEON_GREEN}=== TRADE ENTRY & PROTECTION SETUP COMPLETE ({signal}) ===")
                            else: lg.error(f"{NEON_RED}=== TRADE placed BUT FAILED TO SET/CONFIRM PROTECTION ({signal}) ===")
                        except (ValueError, TypeError, InvalidOperation, KeyError) as post_err:
                            lg.error(f"Error during post-trade processing for {symbol}: {post_err}. Manual check needed!", exc_info=True)
                    else: # Position not confirmed
                        lg.error(f"Trade order {trade_order['id']} placed, but FAILED TO CONFIRM open position! Manual investigation required!")
                else: lg.error(f"=== TRADE EXECUTION FAILED ({signal}). See logs. ===")
            else: lg.info("Signal is HOLD and no open position. No action.")

        # --- Scenario 2: Existing Open Position ---
        else: # open_position is not None
            pos_side = open_position.get('side', 'unknown')
            current_sl_dec = open_position.get('stopLossPriceDecimal'); current_tp_dec = open_position.get('takeProfitPriceDecimal')
            is_tsl_active = open_position.get('is_tsl_active', False)

            # --- Check Exit Conditions ---
            exit_signal = (pos_side == 'long' and signal == "SELL") or (pos_side == 'short' and signal == "BUY")
            ma_cross_exit = False
            if not exit_signal and config.get("enable_ma_cross_exit", False):
                ema_short = analyzer.indicator_values.get("EMA_Short"); ema_long = analyzer.indicator_values.get("EMA_Long")
                if not math.isnan(ema_short) and not math.isnan(ema_long):
                     if (pos_side == 'long' and ema_short < ema_long) or (pos_side == 'short' and ema_short > ema_long):
                          ma_cross_exit = True; lg.warning(f"{NEON_YELLOW}*** MA CROSS EXIT Triggered for {pos_side.upper()} position. ***{RESET}")

            # --- Execute Position Close ---
            if exit_signal or ma_cross_exit:
                reason = f"Opposing Signal ({signal})" if exit_signal else "MA Cross Exit"
                lg.warning(f"*** EXITING {pos_side.upper()} position due to: {reason}. ***")
                try:
                    close_signal = "SELL" if pos_side == 'long' else "BUY"
                    size_str = open_position.get('contracts', open_position.get('info',{}).get('size'))
                    size_to_close = abs(Decimal(str(size_str))) if size_str else None
                    if not size_to_close or size_to_close <= 0: raise ValueError("Invalid size to close")

                    close_order = place_trade(exchange, symbol, close_signal, size_to_close, market_info, lg, reduce_only=True)
                    if close_order:
                         if close_order.get('info',{}).get('retMsg') == 'Position not found on close attempt':
                              lg.info(f"{NEON_GREEN}Position for {symbol} confirmed already closed.{RESET}")
                         else:
                              lg.info(f"Closing order {close_order.get('id', 'N/A')} placed. Waiting {POSITION_CONFIRM_DELAY}s...")
                              time.sleep(POSITION_CONFIRM_DELAY)
                              final_pos = get_open_position(exchange, symbol, lg)
                              if final_pos is None: lg.info(f"{NEON_GREEN}=== POSITION successfully closed. ===")
                              else: lg.error(f"{NEON_RED}*** POSITION CLOSE FAILED verification. Position still detected: {final_pos}{RESET}")
                    else: lg.error(f"{NEON_RED}Failed to place closing order. Manual intervention required.{RESET}")
                except (ValueError, InvalidOperation, TypeError, Exception) as close_err:
                     lg.error(f"Error closing position: {close_err}. Manual intervention required!", exc_info=True)

            # --- Check Break-Even (Only if NOT Exiting) ---
            elif config.get("enable_break_even", False) and not analyzer.break_even_triggered and not is_tsl_active: # Don't move SL if TSL is active
                try:
                    entry_dec = Decimal(str(open_position.get('entryPrice', '0')))
                    atr_dec = Decimal(str(atr_float)) if not math.isnan(atr_float) else None
                    if entry_dec > 0 and atr_dec and atr_dec > 0 and min_tick > 0:
                        trigger_mult = Decimal(str(config["break_even_trigger_atr_multiple"]))
                        offset_ticks = int(config["break_even_offset_ticks"])
                        profit_target = atr_dec * trigger_mult
                        be_stop_price = None; trigger_met = False; trigger_price = None
                        ...
                        if pos_side == 'long':
                            ...
                            if current_price >= trigger_price:
                                ...
                                be_stop_price = max(entry_dec + min_tick, (be_stop_raw / min_tick).quantize(Decimal('1'), rounding=ROUND_UP) * min_tick)
                        elif pos_side == 'short':
                            trigger_price = entry_dec - profit_target
                            if current_price <= trigger_price:
                                trigger_met = True
                                be_stop_raw = entry_dec - (min_tick * offset_ticks)
                                be_stop_price = min(entry_dec - min_tick, (be_stop_raw / min_tick).quantize(Decimal('1'), rounding=ROUND_DOWN) * min_tick)

                        if trigger_met and be_stop_price and be_stop_price > 0:
                            sl_log = f"{current_sl_dec:.{prec}f}" if current_sl_dec else 'N/A'
                            lg.warning(f"{NEON_PURPLE}*** BREAK-EVEN Triggered for {pos_side.upper()}! ***")
                            lg.info(f"  Current: {current_price:.{prec}f}, Trigger: {trigger_price:.{prec}f}, Target BE SL: {be_stop_price:.{prec}f}")
                            modify_needed = True
                            if current_sl_dec: # Check if current SL is already better
                                if (pos_side == 'long' and current_sl_dec >= be_stop_price) or \
                                   (pos_side == 'short' and current_sl_dec <= be_stop_price):
                                     lg.info(f"  Current SL ({sl_log}) already at/beyond BE target. No change."); modify_needed = False; analyzer.break_even_triggered = True

                            if modify_needed:
                                lg.info(f"  Modifying SL to {be_stop_price:.{prec}f}, keeping TP {fmt(current_tp_dec, prec)}.")
                                be_success = _set_position_protection(exchange, symbol, market_info, open_position, lg, be_stop_price, current_tp_dec, '0', '0')
                                if be_success: lg.info(f"{NEON_GREEN}Break-even SL set.{RESET}"); analyzer.break_even_triggered = True
                                else: lg.error(f"{NEON_RED}Failed to set break-even SL.{RESET}")
                        elif trigger_met: lg.error(f"BE triggered, but calculated BE stop ({be_stop_price}) invalid.")
...
def main():
    ...
    parser.add_argument("symbol", help="Trading symbol (e.g., BTC/USDT:USDT or ETH/USDT)")
    parser.add_argument("-d", "--debug", action="store_true", help="Enable DEBUG console logging")
    ...
    if CONFIG.get("interval") not in VALID_INTERVALS:
        logger.critical(f"Invalid 'interval' ({CONFIG.get('interval')}) in config. Must be one of {VALID_INTERVALS}. Exiting."); return

    exchange = initialize_exchange(CONFIG, logger)
    if not exchange: logger.critical("Failed to initialize exchange. Bot cannot start."); return

    market_info = get_market_info(exchange, symbol, logger)
    if not market_info: logger.critical(f"Symbol {symbol} not found or invalid on {exchange.id}. Exiting."); return
    try: # Log key details from market_info
         ...
         logger.info(f"Symbol Details: Contract={market_info.get('is_contract')}, TickSize={tick_size}, MinAmount={min_amt}, MinCost={min_cost}")
    except Exception as e: logger.warning(f"Could not log detailed market info: {e}")
    ...
    while True:
        ...
        except KeyboardInterrupt: logger.info("KeyboardInterrupt received. Shutting down..."); break
        except ccxt.AuthenticationError as e: logger.critical(f"CRITICAL: Auth Error: {e}. Bot stopped."); break
        except ccxt.NetworkError as e: logger.error(f"Network Error: {e}. Retrying after delay..."); time.sleep(RETRY_DELAY_SECONDS * 6)
        except ccxt.RateLimitExceeded as e: wait = _handle_rate_limit(e, logger); logger.warning(f"Rate Limit. Waiting {wait}s..."); time.sleep(wait)
        except ccxt.ExchangeNotAvailable as e: logger.error(f"Exchange Not Available: {e}. Waiting longer..."); time.sleep(config.get("loop_delay", LOOP_DELAY_SECONDS) * 10)
        except ccxt.ExchangeError as e:
            logger.error(f"Exchange Error: {e} (Code: {getattr(e, 'code', 'N/A')})")
            if "maintenance" in str(e).lower(): logger.warning("Maintenance? Waiting longer..."); time.sleep(config.get("loop_delay", LOOP_DELAY_SECONDS) * 20)
            else: time.sleep(RETRY_DELAY_SECONDS * 3) # Moderate delay for other exchange errors
        except Exception as e:
            logger.error(f"UNEXPECTED CRITICAL ERROR: {e}", exc_info=True)
            logger.critical("Bot stopping due to unexpected error."); break

        try: loop_delay = max(1, int(config.get("loop_delay", LOOP_DELAY_SECONDS)))
        except: loop_delay = LOOP_DELAY_SECONDS
...
if __name__ == "__main__":
    try:
        ...
        print(f"\n{NEON_RED}---=== UNHANDLED EXCEPTION CAUGHT AT TOP LEVEL ===---{RESET}")
        print(f"{NEON_RED}Error: {e}{RESET}")
        try: # Attempt to log if possible
            root_logger = logging.getLogger()
            if root_logger and root_logger.hasHandlers(): root_logger.critical("Unhandled exception caused script termination.", exc_info=True)
            else: import traceback; traceback.print_exc()
        except Exception as log_ex: print(f"(Logging failed during exception handling: {log_ex})")
    finally:
