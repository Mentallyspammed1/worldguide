...
readonly MAX_OUTPUT_TOKENS=100000 # Standard high limit, adjust if model supports more
readonly TEMPERATURE=0.5        # Lower value for more deterministic code output
readonly TOP_P=1.0
readonly TOP_K=1
