...
import type { BotConfig, TradeState, PerSymbolState, OrderbookData as typesOrderbookData } from '../../../types';
...
export class MarketMakingBot {
  ...
  private currentStrategy: AdvancedMarketMakingStrategy | BasicMarketMakingStrategy;
  ...
  public async updateOrders(symbol: string) {
