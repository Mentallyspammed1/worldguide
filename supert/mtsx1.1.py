...
print(Fore.CYAN + Style.BRIGHT + "\nThis spell is now yours to command." + Style.RESET_ALL)
print(Fore.YELLOW + "Remember to configure your secrets within a " + Fore.WHITE + Style.BRIGHT + ".env" + Fore.YELLOW + " scroll in the same directory." + Style.RESET_ALL)
print(Fore.CYAN + "The path to true mastery involves diligent study and cautious application. May your endeavors in the Termux realm be fruitful." + Style.RESET_ALL)
print(Fore.MAGENTA + Style.BRIGHT + "\n# Incantation complete. The ether awaits your command." + Style.RESET_ALL)