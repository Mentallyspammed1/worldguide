...
ng 19 1m candles for FARTCOIN/USDT:USDT...
2025-05-01 23:32:29 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend long flip signal (st_long_flip) is not boolean, type: <class 'numpy.bool'>
2025-05-01 23:32:34 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 23:32:34 CDT ==========
2025-05-01 23:32:34 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...
2025-05-01 23:32:36 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend long flip signal (st_long_flip) is not boolean, type: <class 'numpy.bool'>
2025-05-01 23:32:41 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 23:32:41 CDT ==========
2025-05-01 23:32:41 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...
2025-05-01 23:32:42 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend long flip signal (st_long_flip) is not boolean, type: <class 'numpy.bool'>
...
Version: 10.1.1 (Reforged: Class-based Config, Enhanced Fill Confirm, Standardized SL/TP, Pyrmethus Style).
...
def initialize_exchange() -> Optional[ccxt.Exchange]:
    ...
    try:
        ...
        try:
            ...
            # For simplicity, assume CONTRACT for USDT, UNIFIED otherwise. Might need refinement.
            account_type = 'UNIFIED' if settle_currency == USDT_SYMBOL else 'UNIFIED'
            ...
            logger.warning(f"Could not determine settle currency/account type for {CONFIG.symbol} from market info: {e}. Defaulting to {USDT_SYMBOL}/CONTRACT for balance check.")
        except Exception as e:
            logger.warning(f"Unexpected error getting market info for balance check: {e}. Defaulting to {USDT_SYMBOL}/CONTRACT.")
...
def place_risked_market_order(
    ...
    try:
        ...
        account_type: str = 'CONTRACT' if settle_currency == USDT_SYMBOL else 'UNIFIED' # Common default assumption
...
def main() -> None:
    ...
    logger.info(f"{Back.BLUE}{Fore.WHITE}{Style.BRIGHT}--- Pyrmethus Bybit Scalping Spell v10.1.1 Initializing ({start_time_str}) ---{Style.RESET_ALL}")
