            ...
            ~/worldguide/supert main* 4m 55s ❯ nano pyrmethus_scalper1.34py                                                                               ~/worldguide/supert main* ❯ nano pyrmethus_scalper1.4py                                                                                       ~/worldguide/supert main* ❯ nano pyrmethus_scalper1.4.py               Error in /data/data/com.termux/files/home/.nanorc on line 91: Bad regex "[+\-*/%<>=!&|^~@]=?": Invalid range end                                                                                                     ~/worldguide/supert main* 26s ❯ python pyrmethus_scalper1.4.py         2025-05-01 21:58:26 [INFO] --- Summoning Configuration Runes ---       2025-05-01 21:58:26 [SUCCESS] --- Configuration Runes Summoned and Verified ---                                                               2025-05-01 21:58:26 [INFO] --- Pyrmethus Bybit Scalping Spell v10.1.0 Initializing (2025-05-01 21:58:26 CDT) ---                              2025-05-01 21:58:26 [INFO] --- Strategy Enchantment: Dual Supertrend ---                                                                      2025-05-01 21:58:26 [INFO] --- Protective Wards: Exchange Native SL/TP (stopMarket) ---                                                       2025-05-01 21:58:26 [WARNING] --- !!! LIVE FUTURES SCALPING MODE - EXTREME RISK - HANDLE WITH CARE !!! ---                                    2025-05-01 21:58:26 [INFO] Opening portal to Bybit via CCXT...         2025-05-01 21:58:37 [SUCCESS] Portal to Bybit Opened (LIVE SCALPING MODE - EXTREME CAUTION!).                                                 2025-05-01 21:58:37 [INFO] Leverage Conjuring: Attempting to set 50x for FARTCOIN/USDT:USDT...                                                2025-05-01 21:58:37 [INFO] Leverage Conjuring: Leverage for FARTCOIN/USDT:USDT already set to 50x (Confirmed by exchange message).            2025-05-01 21:58:37 [INFO] --- Final Spell Configuration ---           2025-05-01 21:58:37 [INFO] Symbol: FARTCOIN/USDT:USDT, Interval: 1m, Leverage: 50x                                                            2025-05-01 21:58:37 [INFO]   Supertrend Params: ST=2/0.4, ConfirmST=5/0.9                                                                     2025-05-01 21:58:37 [INFO] Risk Ward: 0.500%/trade, Max Pos Value: 20.0000 USDT                                                               2025-05-01 21:58:37 [INFO] SL/TP Wards: SL Mult=1.2, TP Mult=0.4 (ATR Period: 14)                                                             2025-05-01 21:58:37 [INFO] Volume Filter: True (MA=8, Thr=0.5)         2025-05-01 21:58:37 [INFO] Order Book Filter: Use Confirm=True, Fetch Each Cycle=True (Depth=20, L>=1.1, S<=0.9)                              2025-05-01 21:58:37 [INFO] Timing: Sleep=5s, Margin Buffer=105.0%, SMS Alerts=False                                                           2025-05-01 21:58:37 [INFO] Oracle Verbosity (Log Level): NOTSET        2025-05-01 21:58:37 [INFO] ------------------------------              2025-05-01 21:58:37 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 21:58:37 CDT ==========                         2025-05-01 21:58:37 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...                                                      2025-05-01 21:58:38 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend flip signals (st_long_flip, st_short_flip) are not boolean.                                 2025-05-01 21:58:43 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 21:58:43 CDT ==========                         2025-05-01 21:58:43 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...                                                      2025-05-01 21:58:44 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend flip signals (st_long_flip, st_short_flip) are not boolean.                                 2025-05-01 21:58:49 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 21:58:49 CDT ==========                         2025-05-01 21:58:49 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...                                                      2025-05-01 21:58:50 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend flip signals (st_long_flip, st_short_flip) are not boolean.                                 2025-05-01 21:58:55 [INFO] ========== New Weaving Cycle: FARTCOIN/USDT:USDT (1m) | 2025-05-01 21:58:55 CDT ==========                         2025-05-01 21:58:55 [INFO] Data Fetch: Gathering 19 1m candles for FARTCOIN/USDT:USDT...                                                      2025-05-01 21:58:56 [ERROR] Trade Logic: Error accessing or validating indicator/price data from last candle: Supertrend flip signals (st_long_flip, st_short_flip) are not boolean.
...
def calculate_supertrend(
    df: pd.DataFrame, length: int, multiplier: float, prefix: str = ""
     ...
     try:
         ...
         if target_st_val_col in df.columns: df.drop(columns=[target_st_val_col], inplace=True)
         if target_st_trend_col in df.columns: df.drop(columns=[target_st_trend_col], inplace=True)
...
def trade_logic(exchange: ccxt.Exchange, symbol: str, timeframe: str) -> None:
    ...
    try:
        ...
        if not isinstance(st_long_signal, bool) or not isinstance(st_short_signal, bool):
             raise ValueError("Supertrend flip signals (st_long_flip, st_short_flip) are not boolean.")
            ...
            if volume_confirmed and CONFIG.use_ob_confirm:
                ...
                if order_book_data is None or order_book_data.get(BID_ASK_RATIO_KEY) is None:
                    ...
                    if ob_ratio is None: # Defensive check
                        ob_confirmed = False
                        logger.warning(f"{Fore.YELLOW}Entry REJECTED ({selected_side.upper()}): OB Ratio is None unexpectedly.{Style.RESET_ALL}")
                    else:
