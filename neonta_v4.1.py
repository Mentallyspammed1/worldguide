...
/neonta_v4.1.py", line 402, in format
    formatter = logging.Formatter(log_fmt, self.datefmt, style=self._style) # Use self._style here
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/data/data/com.termux/files/usr/lib/python3.12/logging/__init__.py", line 610, in __init__
    raise ValueError('Style must be one of: %s' % ','.join(
ValueError: Style must be one of: %,{,$
Call stack:
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 2880, in <module>
    asyncio.run(main())
  ...
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 2669, in main
    markets_loaded = await temp_client.initialize_markets()
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 594, in initialize_markets
    self.logger.exception(f"Unexpected error loading markets (Attempt {attempt + 1}/{retries}): {e}")
Message: "Unexpected error loading markets (Attempt 1/5): 'NoneType' object has no attribute 'upper'"
Arguments: ()
--- Logging error ---
Traceback (most recent call last):
  ...
  File "/data/data/com.termux/files/usr/lib/python3.12/logging/__init__.py", line 999, in format
    return fmt.format(record)
           ^^^^^^^^^^^^^^^^^^
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 402, in format
    formatter = logging.Formatter(log_fmt, self.datefmt, style=self._style) # Use self._style here
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/data/data/com.termux/files/usr/lib/python3.12/logging/__init__.py", line 610, in __init__
    raise ValueError('Style must be one of: %s' % ','.join(
...
Call stack:
  ...
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 2669, in main
    markets_loaded = await temp_client.initialize_markets()
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 581, in initialize_markets
    self.logger.info(f"Successfully loaded {len(self.markets)} markets from {self.exchange.name}.")
Message: 'Successfully loaded 2605 markets from Bybit.'
Arguments: ()
--- Logging error ---
Traceback (most recent call last):
...
Call stack:
  ...
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 594, in initialize_markets
    self.logger.exception(f"Unexpected error loading markets (Attempt {attempt + 1}/{retries}): {e}")
Message: "Unexpected error loading markets (Attempt 2/5): 'NoneType' object has no attribute 'upper'"
Arguments: ()
--- Logging error ---
Traceback (most recent call last):
  File "/data/data/com.termux/files/usr/lib/python3.12/logging/__init__.py", line 1160, in emit
...
Call stack:
  ...
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 594, in initialize_markets
    self.logger.exception(f"Unexpected error loading markets (Attempt {attempt + 1}/{retries}): {e}")
Message: "Unexpected error loading markets (Attempt 3/5): 'NoneType' object has no attribute 'upper'"
Arguments: ()
^C--- Logging error ---
Traceback (most recent call last):
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 2669, in main
    markets_loaded = await temp_client.initialize_markets()
                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 597, in initialize_markets
    await async_sleep_with_jitter(current_delay)
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 470, in async_sleep_with_jitter
    await asyncio.sleep(seconds + jitter)
  File "/data/data/com.termux/files/usr/lib/python3.12/asyncio/tasks.py", line 665, in sleep
    return await future
           ^^^^^^^^^^^^
...
Call stack:
  ...
  File "/data/data/com.termux/files/usr/lib/python3.12/asyncio/events.py", line 88, in _run
    self._context.run(self._callback, *self._args)
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 2686, in main
    await temp_client.close() # Close the temporary client connection
  File "/data/data/com.termux/files/home/worldguide/neonta_v4.1.py", line 722, in close
    self.logger.info("Closed CCXT exchange connection.")
Message: 'Closed CCXT exchange connection.'
Arguments: ()
# -*- coding: utf-8 -*-
"""
Neonta v4: Cryptocurrency Technical Analysis Bot (Enhanced)
...
getcontext().prec = 18  # Set global Decimal precision (adjust if higher needed)
    ...
    def _merge_dicts(cls, default: dict, user: dict) -> dict:
        ...
        for key, user_value in user.items():
            if key in merged:
                ...
                elif type(user_value) == type(default_value) or default_value is None:
                    # Overwrite default value with user value if key exists and types match (or default is None)
...
class ColorStreamFormatter(logging.Formatter):
    ...
    def __init__(self, fmt: Optional[str] = None, datefmt: Optional[str] = None, style='%', symbol: str = "GENERAL"):
        ...
        self.symbol = symbol
        # Store style attribute correctly (it's _style in base class)
        self._style_char = style # Store the style character if needed later, but use _style

    def format(self, record: logging.LogRecord) -> str:
        """Formats the log record with appropriate colors."""
        level_color = self._level_color_map.get(record.levelno, self._reset_color)

        # Construct the format string dynamically for colorization
        log_fmt = (
        ...
        # Create a *temporary* standard Formatter instance for this record
        # Pass the correct style attribute from the base class (`_style`)
        # Use the datefmt passed during initialization
        formatter = logging.Formatter(log_fmt, self.datefmt, style=self._style) # Use self._style here
...
def format_decimal(value: Optional[Union[Decimal, float, int, str]], precision: int = 2, default_na: str = "N/A") -> str:
    ...
    try:
        ...
        # Create the quantizer string like '0.01' for precision 2
        ...
        # This path might be less common now due to str conversion first
        try:
...
class BybitCCXTClient:
    ...
    def __init__(self, api_key: str, api_secret: str, is_testnet: bool, logger_instance: logging.Logger):
        ...
        self._exchange_config = {
            ...
            'options': {
                ...
                'brokerId': 'NEONTA_V4', # Optional: Set a broker ID
    ...
    def _cache_market_categories(self) -> None:
        ...
        for symbol, details in self.markets.items():
            ...
            if market_type == 'spot':
                ...
                if contract_type == 'linear' or settle_currency == 'USDT':
                    category = 'linear'
                elif contract_type == 'inverse' or settle_currency == 'USD': # Or BTC, ETH etc. for inverse
                    category = 'inverse'
                else:
                    # Fallback guess if contractType is missing/unexpected for futures/swaps
                 ...
                 category = 'option' # Handle options if needed, currently treated like spot/other
            ...
            count += 1
        self.logger.info(f"Cached categories for {count} markets (Spot/Linear/Inverse/Option).")
    ...
    def is_valid_symbol(self, symbol: str) -> bool:
        ...
        if self.markets is None:
            ...
            return False
        is_valid = symbol in self.markets
        if not is_valid:
             self.logger.debug(f"Symbol '{symbol}' not found in loaded markets.")
        return is_valid
    ...
    def get_symbol_details(self, symbol: str) -> Optional[dict]:
        ...
        if not self.is_valid_symbol(symbol):
            # is_valid_symbol already logs if markets aren't loaded or symbol not found
            return None
    ...
    def get_market_category(self, symbol: str) -> str:
        ...
        if details:
            ...
            settle_currency = details.get('settle', '').upper()

            if market_type == 'spot': return 'spot'
            if market_type in ['future', 'swap']:
                if contract_type == 'linear' or settle_currency == 'USDT': return 'linear'
                if contract_type == 'inverse' or settle_currency == 'USD': return 'inverse'
    ...
    async def fetch_with_retry(self, method_name: str, *args: Any, **kwargs: Any) -> Optional[Any]:
        ...
        for attempt in range(retries):
            ...
            # Specific, common transient errors first
                ...
                if retry_after_ms:
                    wait_time = max(float(retry_after_ms) / 1000.0, current_delay) # Use max of suggested or current backoff
                    log_msg = f"Rate limit exceeded calling {method_name} (Attempt {attempt + 1}/{retries}): {e}. Retrying after suggested {wait_time:.1f}s..."
                    current_delay = wait_time # Use the suggested wait time
                else:
    ...
    async def fetch_klines(self, symbol: str, timeframe: str, limit: int) -> pd.DataFrame:
        ...
        try:
            ...
            for col in essential_cols:
                ...
                df[col] = pd.Series(converted_col, index=df.index, dtype=object) # Use object dtype for Decimal
...
class TradingAnalyzer:
        ...
        try:
            ...
            if diff > DECIMAL_COMPARISON_THRESHOLD:
                ...
                for ratio in fib_ratios:
                    ...
                    # Level based on retracement from low (extension concept - less common for basic S/R)
                    # level_up = low + diff * ratio
    ...
    def _format_signal(self, label: str, value: Any, signal: SignalState, precision: int = 2, details: str = "") -> str:
        ...
        Args:
            ...
            value: The numeric value of the indicator (or relevant info). Can be None.
        ...
        """
        # Format the numeric value using the utility function, handle None value
        ...
        color_map = {
            ...
            # SignalState.BREAKDOWN_LOWER: Color.GREEN, # Price breaking below BB lower (potential reversal/buy?) - Color debatable, use Yellow?
            ...
            # SignalState.BREAKOUT_UPPER: Color.RED, # Price breaking above BB upper (potential reversal/sell?) - Color debatable, use Yellow?
            ...
            SignalState.BREAKDOWN_LOWER: Color.YELLOW, # Changed color
            SignalState.BREAKOUT_UPPER: Color.YELLOW, # Changed color
    ...
    def _interpret_trend(self, last_row: pd.Series, prev_row: pd.Series) -> Tuple[List[str], Dict[str, SignalState]]:
        ...
        if flags.ema_alignment:
            ...
            if np.isfinite(ema_short) and np.isfinite(ema_long):
                ...
                # Corrected boolean indexing: Use explicit conditional
        ...
        if flags.psar_flip:
            ...
            psar_rev_signal = self._get_val(last_row, cols.get('psar_rev'), default=0) # Default to 0 (no reversal)
            ...
            if trend_signal != SignalState.NA:
                ...
                # pandas_ta PSARr is 1.0 on the candle *after* the reversal occurs.
                # To detect flip *on* the current candle, we need to compare current trend with previous.
                ...
                # Alternatively, use the PSARr signal if available and reliable for your pandas_ta version
                # elif psar_rev_signal == 1.0:
                #     signal = SignalState.FLIP_BULLISH if trend_signal == SignalState.BULLISH else SignalState.FLIP_BEARISH
                #     details = "Just Flipped!"
    ...
    def _interpret_volume(self, last_row: pd.Series, prev_row: pd.Series) -> Tuple[List[str], Dict[str, SignalState]]:
        ...
        if flags.volume_confirmation:
            ...
            if np.isfinite(volume) and np.isfinite(vol_ma):
                if vol_ma > 1e-9: # Avoid division by zero or near-zero MA
                    ...
                    high_thresh_factor = 1.5
                    low_thresh_factor = 0.7
        ...
        if flags.obv_trend:
            ...
            if np.isfinite(obv_now) and np.isfinite(obv_prev):
                ...
                change_threshold = 0.001 # Example: 0.1% change relative to previous value
    ...
    def _interpret_levels_orderbook(self, current_price: Decimal, levels: dict, orderbook_analysis: dict) -> List[str]:
        ...
        # Values from _analyze_orderbook are already Decimals
    ...
    def analyze(self, df_klines_decimal: pd.DataFrame, current_price: Optional[Decimal], orderbook: Optional[dict]) -> dict:
        ...
        if current_price is None:
             ...
             self.logger.error(f"Invalid current_price type ({type(current_price)}) received for {self.symbol}. Cannot proceed.")
             analysis_result["interpretation"]["summary"] = [Color.format("Invalid current price type, analysis failed.", Color.RED)]
        ...
        try:
            ...
            # --- 2. Calculate Levels ---
            # Levels calculation needs Decimal price, but can use the float OHLCV from df_with_indicators
            levels_decimal = {}
            ...
            if isinstance(current_price, Decimal):
                 ...
                 self.logger.warning("Skipping full interpretation due to missing current price.")
                 analysis_result["interpretation"]["summary"] = [Color.format("Interpretation skipped due to missing current price.", Color.YELLOW)]
                 # Keep signals as NA
    ...
    def format_analysis_output(self, analysis_result: dict) -> str:
        ...
        interval_raw = analysis_result.get('kline_interval', 'N/A')
        # Try to map back to user-friendly interval if possible
        interval_display = interval_raw
        if interval_raw and "days" not in interval_raw: # Basic check to avoid formatting timedeltas directly
             try:
                  # Attempt to parse as timedelta and map back (this is complex)
                  # Simpler: just display the raw interval string from analysis
                  pass # Keep interval_display = interval_raw
             except Exception:
                  pass # Ignore errors in formatting interval
...
async def run_analysis_loop(symbol: str, interval_config: str, client: BybitCCXTClient, analyzer: TradingAnalyzer, logger_instance: logging.Logger) -> None:
    ...
    while True:
        ...
        try:
            ...
            elif klines_result is None or klines_result.empty:
            ...
            if analysis_result:
                ...
                if logger_instance.isEnabledFor(logging.DEBUG):
                    try:
                        ...
                        # and handle potential nested mutable objects
                        log_data = json.loads(json.dumps(analysis_result, default=str)) # Simple way to deep copy and stringify non-serializable
...
async def main() -> None:
    ...
    while True:
        try:
            ...
            if interval_input_lower in REVERSE_CCXT_INTERVAL_MAP:
                selected_interval_key = REVERSE_CCXT_INTERVAL_MAP[interval_input_lower]
            ...
            elif interval_input == '1M' and '1M' in REVERSE_CCXT_INTERVAL_MAP:
                 selected_interval_key = REVERSE_CCXT_INTERVAL_MAP['1M']
                 print(Color.format(f"Using interval {selected_interval_key} (mapped from {interval_input})", Color.CYAN))
                 break
