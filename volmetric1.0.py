        2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:1395) --- Initializing Pyrmethus v4.5.8 (Neon Nexus - VT Edition) ---
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:277) Loaded configuration from .env     2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using SYMBOL: FARTCOIN/USDT:USDT (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using MARKET_TYPE: linear (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:341) Determined Bybit V5 API category: 'linear' for symbol 'FARTCOIN/USDT:USDT', market type 'linear'                           2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using INTERVAL: 3m (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using RISK_PERCENTAGE: 0.005 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using SL_ATR_MULTIPLIER: 1.0 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TP_ATR_MULTIPLIER: 1.2 (from environment variable)                                                                   2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TSL_ACTIVATION_ATR_MULTIPLIER: 0.6 (from environment variable)                                                       2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TRAILING_STOP_PERCENT: 0.2 (from environment variable)                                                               2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using SL_TRIGGER_BY: LastPrice (from environment variable)                                                                 2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TSL_TRIGGER_BY: LastPrice (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using POSITION_IDX: 0 (from environment variable)                                                                          2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TREND_EMA_PERIOD: 210 (from environment variable)                                                                    2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using FAST_EMA_PERIOD: 7 (from environment variable)                                                                       2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using SLOW_EMA_PERIOD: 14 (from environment variable)                                                                      2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using STOCH_PERIOD: 10 (from environment variable)                                                                         2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using STOCH_SMOOTH_K: 3 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using STOCH_SMOOTH_D: 3 (from environment variable)                                                                        2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ATR_PERIOD: 10 (from environment variable)                                                                           2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ADX_PERIOD: 10 (from environment variable)                                                                           2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using STOCH_OVERSOLD_THRESHOLD: 25 (from environment variable)                                                             2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using STOCH_OVERBOUGHT_THRESHOLD: 75 (from environment variable)                                                           2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TREND_FILTER_BUFFER_PERCENT: 0.05 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ATR_MOVE_FILTER_MULTIPLIER: 0.1 (from environment variable)                                                          2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using MIN_ADX_LEVEL: 18 (from environment variable)                                                                        2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:410) Using VT_ENABLE: True (from default value ('True'))                                                                        2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:410) Using VT_TREND_EMA_PERIOD: 200 (from default value ('200'))                                                                2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:410) Using VT_VWMA_PERIOD: 20 (from default value ('20'))                                                                       2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:410) Using VT_VOLUME_SPIKE_LOOKBACK: 20 (from default value ('20'))                                                             2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:410) Using VT_VOLUME_SPIKE_MULTIPLIER: 2.0 (from default value ('2.0'))                                                         2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using BYBIT_API_KEY: **** (from environment variable)                                                                      2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using BYBIT_API_SECRET: **** (from environment variable)                                                                   2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using OHLCV_LIMIT: 200 (from environment variable)                                                                         2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using LOOP_SLEEP_SECONDS: 1 (from environment variable)                                                                    2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ORDER_CHECK_DELAY_SECONDS: 2 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ORDER_FILL_TIMEOUT_SECONDS: 10 (from environment variable)                                                           2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using MAX_FETCH_RETRIES: 3 (from environment variable)                                                                     2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using RETRY_DELAY_SECONDS: 3 (from environment variable)
2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using TRADE_ONLY_WITH_TREND: true (from environment variable)                                                              2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using JOURNAL_FILE_PATH: pyrmethus_trading_journal.csv (from environment variable)                                         2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:410) Using ENABLE_JOURNALING: true (from environment variable)
2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:356) Config Warning: TSL_ACTIVATION_ATR_MULTIPLIER (0.6) < SL_ATR_MULTIPLIER (1). TSL may activate early.
2025-05-10 11:42:34 [WARNING ] (volmetric1.0.py:366) Config Warning: OHLCV_LIMIT (200) may be too small for VT periods (needs ~220).                                            2025-05-10 11:42:34 [INFO    ] (volmetric1.0.py:429) Initializing Bybit exchange (V5 API, Market: linear)...                                                                    2025-05-10 11:42:37 [INFO    ] (volmetric1.0.py:435) Bybit V5 interface initialized & tested.
2025-05-10 11:42:37 [INFO    ] (volmetric1.0.py:443) Loading market info for FARTCOIN/USDT:USDT...                                                                              2025-05-10 11:42:50 [CRITICAL] (volmetric1.0.py:460) Failed to load market info for FARTCOIN/USDT:USDT: cannot access local variable 'dec' where it is not associated with a value. Halting.                                                                            Traceback (most recent call last):                                                        File "/data/data/com.termux/files/home/worldguide/volmetric1.0.py", line 452, in _load_market_info                                                                                market["precision_dp"] = {"amount": get_dp(market.get("precision", {}).get("amount"), DEFAULT_AMOUNT_DP), "price": get_dp(market.get("precision", {}).get("price"), DEFAULT_PRICE_DP)}                                                                                                                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                                                      File "/data/data/com.termux/files/home/worldguide/volmetric1.0.py", line 448, in get_dp                                                                                           if dec.is_nan() or dec.is_zero(): return 0 if dec.is_zero() else default_dp                ^^^                                                                              UnboundLocalError: cannot access local variable 'dec' where it is not associated with a value                                                                                   2025-05-10 11:42:50 [WARNING ] (volmetric1.0.py:1570) Pyrmethus terminated with
...
class TradingConfig:
    ...
    def _determine_v5_category(self) -> str:
        try:
            ...
            if ":" not in self.symbol: # Corrected: self.symbol
    ...
    def _validate_config(self):
        ...
        # Validate VolumaticTrend specific EMA periods
        if self.vt_enable:
            if self.vt_trend_ema_period < self.vt_vwma_period:
                 logger.warning(f"{Fore.YELLOW}Config Warning (VT): VT_TREND_EMA_PERIOD ({self.vt_trend_ema_period}) < VT_VWMA_PERIOD ({self.vt_vwma_period}). This is unusual, ensure it's intended.{Style.RESET_ALL}")
            ...
            if self.ohlcv_limit < min_ohlcv_for_vt:
                 logger.warning(f"{Fore.YELLOW}Config Warning: OHLCV_LIMIT ({self.ohlcv_limit}) may be too small for VT periods (needs ~{min_ohlcv_for_vt}).{Style.RESET_ALL}")
...
class ExchangeManager:
    ...
    def _initialize_exchange(self):
        ...
        except (ccxt.NetworkError, requests.exceptions.RequestException) as e: logger.critical(f"{Style.BRIGHT}{Fore.RED}Network error initializing: {e}. Halting.{Style.RESET_ALL}", exc_info=True); sys.exit(1)
        except Exception as e: logger.critical(f"{Style.BRIGHT}{Fore.RED}Unexpected error initializing: {e}. Halting.{Style.RESET_ALL}", exc_info=True); sys.exit(1)
...
class IndicatorCalculator:
    ...
    def calculate_indicators(self, df: pd.DataFrame) -> Optional[Dict[str, Union[Decimal, bool, int]]]:
        ...
        req_cols = ["open", "high", "low", "close", "volume"] # Added volume
        ...
        try:
            ...
            def to_float(x: Any) -> float:
                ...
                return float('nan') if x is None else float('nan')
            ...
            if init_len > len(df_calc): logger.debug(f"Dropped {init_len - len(df_calc)} rows with NaN in OHLCV for TA.")
            if df_calc.empty: logger.error(f"{Fore.RED}DataFrame empty after NaN drop for TA.{Style.RESET_ALL}"); return None

            max_p_orig = max(self.config.slow_ema_period, self.config.trend_ema_period, self.config.stoch_period + self.config.stoch_smooth_k + self.config.stoch_smooth_d, self.config.atr_period, self.config.adx_period * 2)
            max_p_vt = 0
            if self.config.vt_enable:
                max_p_vt = max(self.config.vt_trend_ema_period, self.config.vt_vwma_period, self.config.vt_volume_spike_lookback)
            max_p = max(max_p_orig, max_p_vt)
            ...
            cl, hi, lo, vol = df_calc["close"], df_calc["high"], df_calc["low"], df_calc["volume"]
            op = df_calc["open"]
            ...
            vt_trend_ema_s = pd.Series(np.nan, index=df_calc.index)
            vt_vwma_s = pd.Series(np.nan, index=df_calc.index)
            vt_volume_avg_s = pd.Series(np.nan, index=df_calc.index)
            vt_is_volume_spike_s = pd.Series(False, index=df_calc.index)

            if self.config.vt_enable:
                vt_trend_ema_s = cl.ewm(span=self.config.vt_trend_ema_period, adjust=False).mean()
                if hasattr(df_calc.ta, 'vwma'): # Check if pandas_ta is correctly extending DataFrame accessor
                    vt_vwma_s = df_calc.ta.vwma(length=self.config.vt_vwma_period,fillna=np.nan)
                else: # Fallback manual VWMA if pandas_ta.vwma is not available for some reason
                    logger.warning("pandas_ta.vwma not found, using manual VWMA calculation (less efficient).")
                    numerator = (cl * vol).rolling(window=self.config.vt_vwma_period).sum()
                    denominator = vol.rolling(window=self.config.vt_vwma_period).sum()
                    vt_vwma_s = numerator / denominator # Handle potential division by zero if all volumes in window are 0
                    vt_vwma_s.replace([np.inf, -np.inf], np.nan, inplace=True) # Replace inf with NaN

                vt_volume_avg_s = vol.rolling(window=self.config.vt_volume_spike_lookback, min_periods=max(1, self.config.vt_volume_spike_lookback//2)).mean()
                vt_is_volume_spike_s = (vol > vt_volume_avg_s * float(self.config.vt_volume_spike_multiplier)) & (vt_volume_avg_s > 0)
            ...
            def latest_bool(s: pd.Series, name: str) -> bool:
                valid_s = s.dropna()
                if valid_s.empty: logger.warning(f"Indicator '{name}' (boolean) series empty/all NaN."); return False
                return bool(valid_s.iloc[-1])


            out: Dict[str, Union[Decimal, bool, int]] = {
                # Original
                ...
                # VolumaticTrend
                "vt_trend_ema": latest_dec(vt_trend_ema_s, "vt_trend_ema"),
                "vt_vwma": latest_dec(vt_vwma_s, "vt_vwma"),
                "vt_volume_avg": latest_dec(vt_volume_avg_s, "vt_volume_avg"),
                "vt_is_volume_spike": latest_bool(vt_is_volume_spike_s, "vt_is_volume_spike"),
                "vt_candle_is_green": cl.iloc[-1] > op.iloc[-1] if not cl.empty and not op.empty else False,
                "vt_candle_is_red": cl.iloc[-1] < op.iloc[-1] if not cl.empty and not op.empty else False,
            }
            
            k_valid = k_s.dropna(); out["stoch_k_prev"] = latest_dec(k_valid.iloc[:-1] if len(k_valid) >=2 else pd.Series(dtype=float), "stoch_k_prev")
            d_valid = d_s.dropna(); d_prev = latest_dec(d_valid.iloc[:-1] if len(d_valid) >=2 else pd.Series(dtype=float), "stoch_d_prev")

            k_now, d_now, k_prev = out["stoch_k"], out["stoch_d"], out["stoch_k_prev"]
            out["stoch_kd_bullish"], out["stoch_kd_bearish"] = False, False
            if not any(v.is_nan() for v in [k_now, d_now, k_prev, d_prev]): # type: ignore[has-type]
                if (k_prev <= d_prev) and (k_now > d_now): out["stoch_kd_bullish"] = True # type: ignore[operator]
                if (k_prev >= d_prev) and (k_now < d_now): out["stoch_kd_bearish"] = True # type: ignore[operator]

            crit_keys = ["fast_ema", "slow_ema", "trend_ema", "atr", "stoch_k", "stoch_d", "adx", "pdi", "mdi"]
            if self.config.vt_enable:
                crit_keys.extend(["vt_trend_ema", "vt_vwma", "vt_volume_avg"])

            failed = [k for k in crit_keys if out.get(k, Decimal("NaN")).is_nan()] # type: ignore[union-attr]
            if failed:
                if out.get("atr", Decimal("NaN")).is_nan(): # type: ignore[union-attr]
                    logger.error(f"{Fore.RED}CRITICAL: ATR is NaN. Risk calc will fail.{Style.RESET_ALL}"); return None 
                logger.warning(f"{Fore.YELLOW}Warning: Indicators NaN: {', '.join(failed)}.{Style.RESET_ALL}")
            
            logger.info(f"{Style.BRIGHT}{Fore.GREEN}Indicator patterns woven.{Style.RESET_ALL}"); return out
...
class SignalGenerator:
    ...
    def _generate_original_signals(self, df_last_candles: pd.DataFrame, indicators: Dict[str, Union[Decimal, bool, int]], current_price: Decimal) -> Tuple[bool, bool, str]:
        """Calculates signals based on the original strategy logic."""
        orig_long_sig, orig_short_sig = False, False
        reason = "Original: Initializing"
        
        prev_cl = safe_decimal(df_last_candles.iloc[-2]["close"]) # From 2nd to last candle
        ...
        px_abv_t = current_price > (t_ema - t_buf_abs); px_blw_t = current_price < (t_ema + t_buf_abs)
        ...
        t_reason = f"(P:{current_price:.{DEFAULT_PRICE_DP}f} vs T_EMA:{t_ema:.{DEFAULT_PRICE_DP}f} ±{t_buf_abs:.{DEFAULT_PRICE_DP}f})" if self.config.trade_only_with_trend else "(TrendFilter OFF)"
        ...
        if self.config.atr_move_filter_multiplier > 0:
            if atr.is_nan() or atr <= 0: atr_f_reason, sig_move = f"(ATR Filter Skip: Invalid ATR {atr.normalize() if not atr.is_nan() else 'NaN'})", False
                ...
                px_move_abs = (current_price - prev_cl).copy_abs()
        ...
        orig_long_sig, orig_short_sig = base_L_sig and t_allows_L and sig_move and adx_allows_L, base_S_sig and t_allows_S and sig_move and adx_allows_S

        if orig_long_sig: reason = f"Original Long: EMA_X {ema_x_state} & StochOK {st_reason} & TrendOK {t_reason} & ATRMoveOK {atr_f_reason} & ADX_OK {adx_f_reason}"
        elif orig_short_sig: reason = f"Original Short: EMA_X {ema_x_state} & StochOK {st_reason} & TrendOK {t_reason} & ATRMoveOK {atr_f_reason} & ADX_OK {adx_f_reason}"
        else:
            parts = ["Original NS:"]
    ...
    def _generate_vt_signals(self, indicators: Dict[str, Union[Decimal, bool, int]], current_price: Decimal) -> Tuple[bool, bool, str]:
        ...
        if not self.config.vt_enable:
            return False, False, "VT: Disabled"

        req_keys = ["vt_trend_ema", "vt_vwma", "vt_volume_avg"] # vt_is_volume_spike is bool
        ind_vals: Dict[str, Decimal] = {}
        nan_keys = [k for k in req_keys if not isinstance(indicators.get(k), Decimal) or indicators.get(k, Decimal("NaN")).is_nan()] # type: ignore[union-attr]
        
        is_vol_spike = indicators.get("vt_is_volume_spike", False)
        is_green_candle = indicators.get("vt_candle_is_green", False)
        is_red_candle = indicators.get("vt_candle_is_red", False)

        if not isinstance(is_vol_spike, bool) or not isinstance(is_green_candle, bool) or not isinstance(is_red_candle, bool):
             nan_keys.append("vt_bool_indicators_invalid_type")


        if nan_keys:
            reason = f"VT: Indicators NaN/Missing: {', '.join(nan_keys)}."
            return vt_long_sig, vt_short_sig, reason
        
        for k in req_keys: ind_vals[k] = indicators[k] # type: ignore[assignment]
        vt_trend_ema, vt_vwma = ind_vals["vt_trend_ema"], ind_vals["vt_vwma"]
        
        # VT Long Conditions
        is_uptrend_vt = current_price > vt_trend_ema
        price_above_vwma = current_price > vt_vwma
        if is_uptrend_vt and price_above_vwma and is_vol_spike and is_green_candle: # type: ignore[operator]
            vt_long_sig = True
            reason = (f"VT Long: TrendUP (P>{vt_trend_ema:.{DEFAULT_PRICE_DP}f}), "
                      f"Price>VWMA (P>{vt_vwma:.{DEFAULT_PRICE_DP}f}), VolSpike, GreenCandle")
        
        # VT Short Conditions
        is_downtrend_vt = current_price < vt_trend_ema
        price_below_vwma = current_price < vt_vwma
        if not vt_long_sig and is_downtrend_vt and price_below_vwma and is_vol_spike and is_red_candle: # type: ignore[operator]
            vt_short_sig = True
            reason = (f"VT Short: TrendDN (P<{vt_trend_ema:.{DEFAULT_PRICE_DP}f}), "
                      f"Price<VWMA (P<{vt_vwma:.{DEFAULT_PRICE_DP}f}), VolSpike, RedCandle")

        if not vt_long_sig and not vt_short_sig:
            reason = (f"VT NS: Trend(P:{current_price:.{DEFAULT_PRICE_DP}f} vs EMA:{vt_trend_ema:.{DEFAULT_PRICE_DP}f}={'UP' if is_uptrend_vt else 'DN' if is_downtrend_vt else 'N'}), "
                      f"VWMA(P:{current_price:.{DEFAULT_PRICE_DP}f} vs VWMA:{vt_vwma:.{DEFAULT_PRICE_DP}f}={'ABV' if price_above_vwma else 'BLW' if price_below_vwma else 'N'}), "
                      f"VolSpike:{is_vol_spike}, Candle:{'Grn' if is_green_candle else 'Red' if is_red_candle else 'N'}")
    ...
    def generate_signals(self, df_last_candles: pd.DataFrame, indicators: Dict[str, Union[Decimal, bool, int]]) -> Dict[str, Union[bool, str]]:
        ...
        try:
            ...
            orig_long, orig_short, orig_reason = self._generate_original_signals(df_last_candles, indicators, curr_px)

            # Generate signals from VolumaticTrend strategy (if enabled)
            vt_long, vt_short, vt_reason = False, False, "VT: Disabled"
            if self.config.vt_enable:
                vt_long, vt_short, vt_reason = self._generate_vt_signals(indicators, curr_px)

            # Combine signals
            final_long = orig_long or vt_long
            final_short = orig_short or vt_short

            if final_long and final_short: # Both strategies signal opposite, prioritize original or hold?
                logger.warning(f"Conflicting signals: Original ({'L' if orig_long else 'S' if orig_short else 'N'}) vs VT ({'L' if vt_long else 'S' if vt_short else 'N'}). Holding.")
                res["long"], res["short"] = False, False
                res["reason"] = f"Signal Conflict: Orig({orig_reason}) AND VT({vt_reason}). Holding."
            elif final_long:
                res["long"] = True
                if orig_long and vt_long: res["reason"] = f"Orig&VT Long: {orig_reason} | {vt_reason}"
                elif orig_long: res["reason"] = f"{orig_reason} (VT no signal: {vt_reason})"
                else: res["reason"] = f"{vt_reason} (Orig no signal: {orig_reason})" # vt_long is true
            elif final_short:
                res["short"] = True
                if orig_short and vt_short: res["reason"] = f"Orig&VT Short: {orig_reason} | {vt_reason}"
                elif orig_short: res["reason"] = f"{orig_reason} (VT no signal: {vt_reason})"
                else: res["reason"] = f"{vt_reason} (Orig no signal: {orig_reason})" # vt_short is true
            else: # No signal from either
                res["reason"] = f"No Signal. Orig: {orig_reason} | VT: {vt_reason}"

            log_lvl = logging.INFO if res["long"] or res["short"] or "Blocked" in res["reason"] or "Conflict" in res["reason"] else logging.DEBUG
    ...
    def check_exit_signals(self, position_side: str, indicators: Dict[str, Union[Decimal, bool, int]]) -> Optional[str]:
        ...
        req_orig = {"fast_ema": f_ema_v, "slow_ema": s_ema_v, "stoch_k_current": k_curr_v, "stoch_k_previous": k_prev_v}
        orig_exit_reason: Optional[str] = None
        
        valid_orig_inds = True
        for name, val in req_orig.items():
            if not isinstance(val, Decimal) or val.is_nan():
                logger.debug(f"Orig Exit check: Indicator '{name}' invalid ({val})."); valid_orig_inds = False; break
        ...
        if valid_orig_inds:
            ...
            if position_side == "long":
                if ema_bear: orig_exit_reason = f"Exit (L Orig): EMA Bearish Cross (F {f_ema.normalize()} < S {s_ema.normalize()})"
                elif k_prev >= ob_lvl and k_curr < ob_lvl: orig_exit_reason = f"Exit (L Orig): Stoch Reversal OB (PrevK {k_prev.normalize():.1f} >= OB {ob_lvl.normalize()} -> CurrK {k_curr.normalize():.1f} < OB)"
            elif position_side == "short":
                if ema_bull: orig_exit_reason = f"Exit (S Orig): EMA Bullish Cross (F {f_ema.normalize()} > S {s_ema.normalize()})"
                elif k_prev <= os_lvl and k_curr > os_lvl: orig_exit_reason = f"Exit (S Orig): Stoch Reversal OS (PrevK {k_prev.normalize():.1f} <= OS {os_lvl.normalize()} -> CurrK {k_curr.normalize():.1f} > OS)"
        
        if orig_exit_reason: logger.trade(f"{Fore.YELLOW}{orig_exit_reason}{Style.RESET_ALL}"); return orig_exit_reason

        # VolumaticTrend Exit Logic (if enabled and original didn't fire)
        if self.config.vt_enable:
            vt_exit_reason: Optional[str] = None
            curr_px = indicators.get("close_price") # Need current price, assume it's passed or get from indicators
            vt_trend_ema_v = indicators.get("vt_trend_ema")
            vt_vwma_v = indicators.get("vt_vwma")
            is_vol_spike = indicators.get("vt_is_volume_spike", False)
            is_red_candle = indicators.get("vt_candle_is_red", False)
            is_green_candle = indicators.get("vt_candle_is_green", False)

            req_vt = {"close_price": curr_px, "vt_trend_ema": vt_trend_ema_v, "vt_vwma": vt_vwma_v}
            valid_vt_inds = True
            for name, val in req_vt.items():
                 if not isinstance(val, Decimal) or val.is_nan():
                     logger.debug(f"VT Exit check: Indicator '{name}' invalid ({val})."); valid_vt_inds = False; break
            
            if valid_vt_inds:
                price, vt_trend_ema, vt_vwma = curr_px, vt_trend_ema_v, vt_vwma_v # type: ignore[assignment]
                if position_side == "long":
                    if price < vt_trend_ema: vt_exit_reason = f"Exit (L VT): Price < VT Trend EMA ({vt_trend_ema.normalize()})" # type: ignore[operator]
                    elif price < vt_vwma and is_vol_spike and is_red_candle: vt_exit_reason = f"Exit (L VT): Price < VT VWMA ({vt_vwma.normalize()}) + VolSpike on Red" # type: ignore[operator]
                elif position_side == "short":
                    if price > vt_trend_ema: vt_exit_reason = f"Exit (S VT): Price > VT Trend EMA ({vt_trend_ema.normalize()})" # type: ignore[operator]
                    elif price > vt_vwma and is_vol_spike and is_green_candle: vt_exit_reason = f"Exit (S VT): Price > VT VWMA ({vt_vwma.normalize()}) + VolSpike on Green" # type: ignore[operator]

            if vt_exit_reason: logger.trade(f"{Fore.YELLOW}{vt_exit_reason}{Style.RESET_ALL}"); return vt_exit_reason
        
        return None

# --- Order Manager Class (largely unchanged, assumed robust) ---
class OrderManager:
    ...
    def _set_position_protection(self, position_side: str, sl_price: Optional[Decimal] = None, tp_price: Optional[Decimal] = None, is_tsl: bool = False, tsl_distance: Optional[Decimal] = None, tsl_activation_price: Optional[Decimal] = None) -> bool:
        ...
        if not hasattr(self.exchange, method_name): logger.critical(f"{Style.BRIGHT}{Fore.RED}CCXT method '{method_name}' not found. Cannot manage protection.{Style.RESET_ALL}"); return False
        try:
            resp = fetch_with_retries(getattr(self.exchange, method_name), params=api_params, max_retries=self.config.max_fetch_retries, delay_seconds=self.config.retry_delay_seconds)
...
class StatusDisplay:
    ...
    def print_status_panel(self, cycle_num: int, current_timestamp: Optional[datetime], current_market_price: Optional[Decimal], indicators_data: Optional[Dict[str, Any]], current_positions_summary: Optional[Dict[str, Dict[str, Any]]], account_equity: Optional[Decimal], signal_check_result_or_status: Dict[str, Any], protection_status_tracker: Dict[str, Optional[str]], market_specific_info: Optional[Dict[str, Any]]):
        ...
        if market_specific_info and "precision_dp" in market_specific_info:
             ...
             amount_dp = market_specific_info["precision_dp"].get("amount", self._default_amount_dp) 
        ...
        if indicators_data:
            parts = []
            def fmt_ind(k: str, p: int = 1, s: str = "white", is_bool: bool = False) -> Text:
                 v = indicators_data.get(k)
                 if is_bool: return Text(str(v), style=s if v else "dim " + s) # Dim if False
                 if isinstance(v, bool): return Text(str(v), style=s) # Should use is_bool for these
            ...
            if self.config.vt_enable and indicators_data.get('vt_trend_ema') is not None:
                vt_parts = [Text("VT: ", style="bold green")]
                ...
                vol_spike_status = "Yes" if indicators_data.get('vt_is_volume_spike') else "No"
                vt_parts.append(Text(f"VolSpike:{vol_spike_status}", style="green" if indicators_data.get('vt_is_volume_spike') else "dim green"))
                parts.append(Text(" | ", style="dim").join(vt_parts))
        ...
        if active_pos_side and active_pos_data:
            ...
            pos_disp = Text(f"{active_pos_side.upper()}: ",style=style); pos_disp.append("Qty=",style=style).append(self._format_decimal_for_rich(active_pos_data.get("qty"),amount_dp))
        ...
        if signal_check_result_or_status.get("long",False) or "Long Signal" in reason or "ENTERED_long" in reason or "Orig&VT Long" in reason or "VT Long" in reason: style_key="bold bright_green"
        elif signal_check_result_or_status.get("short",False) or "Short Signal" in reason or "ENTERED_short" in reason or "Orig&VT Short" in reason or "VT Short" in reason: style_key="bold bright_red"
        elif "Blocked" in reason or "FAIL" in reason.upper() or "EmergencyClose" in reason or "Conflict" in reason: style_key="yellow"
...
class TradingBot:
    ...
    def _display_startup_info(self):
        ...
        vt_status = f"VT Strategy Enabled: {self.config.vt_enable}"
        console.print(Panel(Text(
            ...
            f"Journaling: {self.config.enable_journaling} ('{self.config.journal_file_path}')\n"
    ...
    def trading_spell_cycle(self, cycle_num: int):
        ...
        indicators["close_price"] = curr_px # Add current price to indicators dict for exit signal check convenience
        ...
        if pos_summary.get("long",{}): active_side, active_pos = "long", pos_summary["long"]
        elif pos_summary.get("short",{}): active_side, active_pos = "short", pos_summary["short"]
        ...
        if active_side and active_pos:
            ...
            # Check exits only if TSL not primary (or if TSL is active but we still want signal exits)
            # Current logic: If TSL active, it's the main exit. Signal exits are for SL/TP phase.
            # This can be configured. For now, if TSL active, we don't check signal exits.
            # An alternative: check_exit_signals might override TSL if a strong counter-signal appears.
            # For simplicity: if TSL active, it manages exit. Otherwise, check strategy signal exits.
            if self.order_manager.protection_tracker.get(active_side) != "ACTIVE_TSL":
                exit_sig_reason = self.signal_generator.check_exit_signals(active_side, indicators)
                if exit_sig_reason:
                    logger.trade(f"Attempting close {active_side.upper()} due to: {exit_sig_reason}")
                    if not qty.is_nan() and qty > 0:
                        closed = self.order_manager.close_position(active_side, qty, reason=exit_sig_reason)
                        status_dict = {"reason": f"CLOSED_{active_side.upper()}_BY_SIGNAL: {exit_sig_reason}" if closed else f"FAIL:CLOSE_SIGNAL_{active_side.upper()}"}
                        pos_summary = self.exchange_manager.get_current_position(); self.status_display.print_status_panel(cycle_num, last_ts, curr_px, indicators, pos_summary, equity, status_dict, self.order_manager.protection_tracker, self.exchange_manager.market_info); return
                    else: logger.warning(f"Exit signal for {active_side.upper()} but qty invalid ({qty}).")
            
            # Re-check position state after potential TSL activation or exit signals
            # to see if it was closed by exchange stops or our own exit logic.
            final_check_pos_summary = self.exchange_manager.get_current_position()
            if final_check_pos_summary:
                pos_summary = final_check_pos_summary
                new_long_pos, new_short_pos = pos_summary.get("long",{}), pos_summary.get("short",{})
                if not (new_long_pos or new_short_pos) and active_side: # Was in position, now flat
                    logger.info(f"Position {active_side.upper()} appears closed (e.g., by exchange SL/TP/TSL).")
                    status_dict = {"reason": f"INFO:POS_{active_side.upper()}_CLOSED_BY_EXCH_STOP_OR_SIGNAL"}
                    self.order_manager.protection_tracker[active_side] = None
                    active_side = None # Now flat
            else: logger.warning("Failed to re-fetch pos state after TSL/exit checks for cycle end.")
            # active_side might be None now if position closed

        if not active_side: # If flat (either initially or after an exit in this cycle)
            ...
            status_dict = entry_signals # Update status from signal generation

            target_order_side: Optional[str] = None
            if entry_signals.get("long"): target_order_side = "buy"
            elif entry_signals.get("short"): target_order_side = "sell"

            if target_order_side:
                atr_val = indicators.get("atr", Decimal("NaN")) # type: ignore[union-attr]
                if not atr_val.is_nan() and atr_val > 0:
                    entry_success = self.order_manager.place_risked_market_order(target_order_side, atr_val, equity, curr_px)
                    entered_side = "long" if target_order_side == "buy" else "short"
                    status_dict = {"reason": f"ENTERED_{entered_side.upper()}" if entry_success else f"FAIL:ENTRY_{entered_side.upper()}"}
                    pos_summary = self.exchange_manager.get_current_position() # Refresh for display
                    self.status_display.print_status_panel(cycle_num, last_ts, curr_px, indicators, pos_summary, equity, status_dict, self.order_manager.protection_tracker, self.exchange_manager.market_info); return
                else:
                    logger.warning(f"Cannot attempt {target_order_side.upper()} entry: Invalid ATR ({atr_val}).")
                    status_dict = {"reason": f"FAIL:ENTRY_INVALID_ATR_{target_order_side.upper()}"}
        else: # Still in an active position, no exit signal
    ...
    def graceful_shutdown(self):
        ...
        logger.info("Exchange-side protections (SL/TP/TSL) remain active. No client-side orders to cancel.")
...
if __name__ == "__main__":
    try:
        ...
        if 'colorama_init' in globals() and 'Fore' in globals() and 'Style' in globals():
             colorama_init(autoreset=True)
             err_msg = f"{Style.BRIGHT}{Fore.RED}CRITICAL UNHANDLED EXCEPTION: {main_exception}{Style.RESET_ALL}"
        else: err_msg = f"CRITICAL UNHANDLED EXCEPTION: {main_exception}"
        if 'logger' in globals() and hasattr(logger, 'critical'): logger.critical(err_msg, exc_info=True)
        else: print(err_msg, file=sys.stderr); import traceback; traceback.print_exc()
        if 'termux_notify' in globals(): termux_notify("Pyrmethus CRASHED", "Critical unhandled exception.")
        sys.exit(1)
