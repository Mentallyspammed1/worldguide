...
def attempt_new_entry(
    ...
    tsl_price_distance: Optional[Decimal] = None
    tsl_active_price: Optional[Decimal] = None
...
def check_exit_conditions(
    ...
    latest_signal = "HOLD" # Default
    if analyzer.signals["BUY"] == 1: latest_signal = "BUY"
    elif analyzer.signals["SELL"] == 1: latest_signal = "SELL"
...
def main():
    ...
    if args.debug:
        print("Debug mode enabled. Console logging set to DEBUG.")
...
if __name__ == "__main__":
    try:
        ...
        print(f"{NEON_RED}A critical error occurred. Check the main log file. Exiting.{RESET}")
    finally:
