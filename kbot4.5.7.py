  ...
  File "/data/data/com.termux/files/home/worldguide/kbot4.5.7.py", line 2993, in <module>
    bot = TradingBot()
          ^^^^^^^^^^^^
  File "/data/data/com.termux/files/home/worldguide/kbot4.5.7.py", line 2596, in __init__
    self.exchange_manager = ExchangeManager(self.config)
                            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/data/data/com.termux/files/home/worldguide/kbot4.5.7.py", line 624, in __init__                                                          self._initialize_exchange()
  File "/data/data/com.termux/files/home/worldguide/kbot4.5.7.py", line 668, in _initialize_exchange                                              f"{Fore.BRIGHT_RED}Network error initializing exchange: {e}. Check connection. Halting.",                                                        ^^^^^^^^^^^^^^^
AttributeError: 'AnsiFore' object has no attribute 'BRIGHT_RED'

During handling of the above exception, another exception occurred:

Traceback (most recent call last):
  File "/data/data/com.termux/files/home/worldguide/kbot4.5.7.py", line 2999, in <module>
    ...
    def trading_spell_cycle(self, cycle_count: int) -> None:
        ...
        if current_atr.is_nan() or current_atr <= 0:
            ...
            if cycle_status != "WARN:INDICATORS_FAILED":
                ...
                logger.warning(f"{Fore.YELLOW}Invalid ATR ({current_atr}) due to indicator failure. Logic skipped.")
