...
def place_market_order_slippage_check(
    ...
    config: Config, max_slippage_pct_override: Decimal | None = None,
    is_reduce_only: bool = False, client_order_id: str | None = None
) -> dict | None:
...
def cancel_all_orders(exchange: ccxt.bybit, symbol: str, config: Config, reason: str = "Cleanup", order_filter: Literal['Order', 'StopOrder', 'tpslOrder'] | None = None) -> bool:
...
def cancel_order(exchange: ccxt.bybit, symbol: str, order_id: str, config: Config, order_filter: Literal['Order', 'StopOrder', 'tpslOrder'] | None = None) -> bool:
...
def fetch_order(exchange: ccxt.bybit, symbol: str, order_id: str, config: Config, order_filter: Literal['Order', 'StopOrder', 'tpslOrder'] | None = None) -> dict | None:
...
def place_limit_order_tif(
    ...
    is_reduce_only: bool = False, is_post_only: bool = False, client_order_id: str | None = None
) -> dict | None:
...
def close_position_reduce_only(
    exchange: ccxt.bybit, symbol: str, config: Config, position_to_close: dict[str, Any] | None = None, reason: str = "Signal Close"
) -> dict[str, Any] | None:
...
def place_native_stop_loss(
    ...
    trigger_by: Literal['LastPrice', 'MarkPrice', 'IndexPrice'] = 'MarkPrice', client_order_id: str | None = None, position_idx: Literal[0, 1, 2] = 0
) -> dict | None:
...
def fetch_open_orders_filtered(
    exchange: ccxt.bybit, symbol: str, config: Config, side: Literal['buy', 'sell'] | None = None,
    order_type: str | None = None, order_filter: Literal['Order', 'StopOrder', 'tpslOrder'] | None = None
) -> list[dict] | None:
...
def place_native_trailing_stop(
    exchange: ccxt.bybit, symbol: str, side: Literal['buy', 'sell'], amount: Decimal, trailing_offset: Decimal | str, config: Config,
    activation_price: Decimal | None = None, trigger_by: Literal['LastPrice', 'MarkPrice', 'IndexPrice'] = 'MarkPrice',
    client_order_id: str | None = None, position_idx: Literal[0, 1, 2] = 0
) -> dict | None:
...
def update_limit_order(
    exchange: ccxt.bybit, symbol: str, order_id: str, config: Config, new_amount: Decimal | None = None,
    new_price: Decimal | None = None, new_trigger_price: Decimal | None = None,  # For conditional orders
...
def fetch_position_risk_bybit_v5(exchange: ccxt.bybit, symbol: str, config: Config) -> dict[str, Any] | None:
    ...
    try:
        ...
        params = {'category': category, 'symbol': market_id}; position_data: list[dict] | None = None; fetch_method_used = "N/A"
