...
LOGGING_CONFIG = {
    ...
    "LOG_FILE": os.getenv("LOG_FILE_PATH", "trading_bot.log"),  # File name/path for logs
    "CONSOLE_LEVEL_STR": os.getenv("LOG_CONSOLE_LEVEL", "INFO").upper(),  # DEBUG, INFO, WARNING, ERROR, CRITICAL
...
print(f"Configuration loaded successfully. Testnet Mode: {API_CONFIG.get('TESTNET_MODE')}")
