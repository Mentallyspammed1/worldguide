...
def print_status_panel(
    ...
    print(f" Equity: {Fore.GREEN}{equity:.4f} USDT" + Style.RESET_ALL) # Assuming USDT equity
    ...
    trend_status = f"(Trend Filter: {Fore.WHITE}{'ON' if CONFIG.trade_only_with_trend else 'OFF'}{Fore.MAGENTA})"
...
if __name__ == "__main__":
    ...
    if MARKET_INFO: # Check if market info loaded successfully
         ...
         logger.info(f"Awaiting market whispers...")
    else:
