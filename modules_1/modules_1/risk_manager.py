...
import ccxt.async_support as ccxt_async  # For type hinting Exchange

# Import utility functions
from utils import NEON_GREEN, RESET_ALL_STYLE as RESET, get_price_precision
...
def calculate_position_size(
    ...
    try:
        ...
        cost_calc_price_final = entry_price
        if market_info.get("linear", True) or not is_contract:
