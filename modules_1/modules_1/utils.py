...
DEFAULT_INDICATOR_PERIODS = {
    ...
    "volume_ma_period": 15,
    "fibonacci_window": 50,
    "psar_initial_af": 0.02,  # Added for analysis.py
    "psar_af_step": 0.02,  # Added for analysis.py (replaces psar_af)
    "psar_max_af": 0.2,
    # Default values for any other parameters used by analysis.py's INDICATOR_CONFIG
    "cci_constant": 0.015,  # Default constant for CCI if not in config
    "momentum_threshold_pct": 0.1,  # Default for momentum check
    "volume_confirmation_multiplier": 1.5,  # Default for volume check
    "stoch_rsi_oversold_threshold": 20,
    "stoch_rsi_overbought_threshold": 80,
    "stoch_rsi_cross_threshold": 5.0,
    "rsi_oversold_threshold": 30,
    "rsi_overbought_threshold": 70,
    "rsi_near_oversold_threshold": 40,
    "rsi_near_overbought_threshold": 60,
    "cci_strong_oversold": -150,
    "cci_strong_overbought": 150,
    "cci_moderate_oversold": -100,
    "cci_moderate_overbought": 100,
    "wr_oversold_threshold": -80,
    "wr_overbought_threshold": -20,
    "wr_midpoint_threshold": -50,
    "mfi_oversold_threshold": 20,
    "mfi_overbought_threshold": 80,
    "mfi_near_oversold_threshold": 35,
    "mfi_near_overbought_threshold": 65,
    "default_atr_percentage_of_price": "0.01",  # For TP/SL calc if ATR is invalid
    "orderbook_check_levels": 10,  # For orderbook analysis
    "min_active_indicators_for_signal": 3,  # Default min indicators for a signal
    "signal_score_threshold": 0.7,  # Default signal score threshold
    "indicator_buffer_candles": 20,  # Buffer candles for indicator calculation
}
...
RESET_ALL_STYLE = Style.RESET_ALL  # Use this for resetting colors
